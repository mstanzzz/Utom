...
$sql = "DELETE FROM faq WHERE profile_account_id > '1'";
$result = $dbCustom->getResult($db,$sql);


$sql = "SELECT * FROM faq WHERE profile_account_id = '1'";
$result = $dbCustom->getResult($db,$sql);
...
while($row = $result->fetch_object()) {
	...
	$sql = "INSERT INTO faq 
			(profile_account_id, question, answere)
			VALUES
			('100', '".$row->question."', '".$row->answere."')";
...
$sql = "DELETE FROM faq_category WHERE profile_account_id > '1'";
$result = $dbCustom->getResult($db,$sql);


$sql = "SELECT * FROM faq_category WHERE profile_account_id = '1'";
$result = $dbCustom->getResult($db,$sql);
...
while($row = $result->fetch_object()) {
	...
	$sql = "INSERT INTO faq_category 
			(profile_account_id, category_name)
			VALUES
			('100', '".$row->category_name."')";
