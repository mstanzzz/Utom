...
$cms_block .= "<li><a href='".$ste_root."manage/cms/seo/seo.php'>SEO/Breadcrumbs</a></li>";
$cms_block .= "<li><a href='".$ste_root."manage/cms/custom-code/custom-code.php?firstload=1'>Custom Code / Meta tags</a></li>";                
$cms_block .= "<li><a href='".$ste_root."manage/cms/logo/logo.php'>Logo</a></li>";                
$cms_block .= "<li><a href='".$ste_root."manage/cms/footer/edit-footer.php'>Footer</a></li>";                
...
$cat_block .= "<li><a href='".$ste_root."manage/catalog/products/custom-measurements.php'>Custom Measurements</a></li>";     
$cat_block .= "</ul>";
$cat_block .= "</li>";
...
$ecom_block .= "</span>";
$ecom_block .= "<a href='".$ste_root."manage/ecomsettings/ecommerce-landing.php' "; 
$ecom_block .= multipleDirectories($ecom_open,1);
$ecom_block .= "> Ecommerce Settings</a>";
$ecom_block .= "<ul ";            
$ecom_block .=multipleDirectories($ecom_open,1);
$ecom_block .=">";
$ecom_block .="<li><a href='".$ste_root."manage/ecomsettings/global-discount.php'>Discount Settings</a></li>";
$ecom_block .="<li><a href='".$ste_root."manage/ecomsettings/showroom-banner.php'>Showroom Page Banners</a></li>";
$ecom_block .="<li><a href='".$ste_root."manage/ecomsettings/shop-banner.php'>Shopping Page Banners</a></li>";
$ecom_block .="<li><a href='".$ste_root."manage/ecomsettings/ship-carrier.php'>Shipping Options</a></li>";				
$ecom_block .="<li><a href='".$ste_root."manage/ecomsettings/payment-processor.php'>Payment Processor</a></li>";
$ecom_block .="</ul>";
$ecom_block .="</li>";
...
$cust_block .= "</span>";
$cust_block .= "<a href='".$ste_root."manage/customer/customer-landing.php' "; 
$cust_block .= multipleDirectories($custord_open,1);
$cust_block .= "> Customers &amp; Orders</a>";
$cust_block .= "<ul "; 
$cust_block .= multipleDirectories($custord_open,1);
$cust_block .= ">";
$cust_block .= "<li><a href='".$ste_root."manage/customer/customer-list.php'>Customers</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/general-admin/contact-email.php'>Contact Emails</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/general-admin/testimonial-list.php'>Testimonials</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/general-admin/feedback.php'>Feedback</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/order-management/master/order-list.php'>Orders</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/order-management/master/transaction-list.php'>Transaction List</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/order-management/master/failed-order-list.php'>Failed Orders</a></li>";
$cust_block .= "<li><a href='".$ste_root."manage/order-management/process-definition.php'>Processes Definitions</a></li>";            
$cust_block .= "<li><a href='".$ste_root."manage/customer/edit-review-email.php'>Edit Review Email Text</a></li>";            
$cust_block .= "<li><a href='".$ste_root."manage/customer/bulk-email.php'>Bulk Email</a></li>";           
$cust_block .= "</ul>";
$cust_block .= "</li>";
...
$adm_block .= "</span>";
$adm_block .= "<a href='".$ste_root."manage/general-admin/admin-landing.php'> Administration</a>";
$adm_block .= " <ul ";
...
$mast_block .= "</span>";
$mast_block .= "<a href='".$ste_root."manage/master-admin/master-admin-landing.php' ";
$mast_block .= multipleDirectories($master_admin_open,1);
$mast_block .= ">OTG Administration</a>";
$mast_block .= "<ul ";
$mast_block .= multipleDirectories($master_admin_open,1);
$mast_block .= ">";   
$mast_block .= "<li><a href='".$ste_root."manage/master-admin/sas-cust.php'>SaaS Customers</a></li>";
$mast_block .= "<li><a href='".$ste_root."manage/order-management/master/costco-order-list.php'>Costco</a></li>";			
$mast_block .= "<li><a href='".$ste_root."manage/master-admin/news.php'>News</a></li>";      
$mast_block .= "</ul>";
$mast_block .= "</li>";
...
$des_block .= "</span>";
$des_block .= "<a href='".$ste_root."manage/design/design-landing.php' ";
$des_block .= multipleDirectories($design_open,1);
$des_block .= ">Design</a>";
$des_block .= "<ul ";
$des_block .= multipleDirectories($design_open,1);
$des_block .= ">";   
$des_block .= "<li><a href='".$ste_root."manage/design/design-email.php'>Design Requests</a></li>";
$des_block .= "<li><a href='".$ste_root."manage/design/in-home-consult.php'>Design Consultation</a></li>";
$des_block .= "<li><a href='".$ste_root."manage/design/design-req-origin-stats.php'>Design Request Origin Statistics</a></li>";
$des_block .= "</ul>";
$des_block .= "</li>";
...
<br />
	...
	<?php		
	$url_str =  $ste_root."manage/order-management/master/transaction-list.php";
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/fulfillment/fulfillment-landing.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/fulfillment/tool-design-orders.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Fulfillment</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/fulfillment/customise-ff-steps.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Fulfillment</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/fulfillment/tool-design-orders-complete.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/general-admin/admin-landing.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Completed Design Orders</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/general-admin/edit-company-profile.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/general-admin/add-on-change-request.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/general-admin/add-ons.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Add-ons Change Request</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/admin-users/admin-users.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Add-ons Change Request</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/general-admin/states.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Add-ons Change Request</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/master-admin/master-admin-landing.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Add-ons Change Request</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/master-admin/sas-cust.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	echo "<a href='".$url_str."' class='dashlink' title=''>Add-ons Change Request</a>";	
	?>
	</li>			
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/master-admin/news.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/design/design-landing.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/design/design-email.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/design/in-home-consult.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/design/design-req-origin-stats.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/design/tool-design-list.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/design/tool-landing.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/tool/general-setup.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/tool/material-setup.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/tool/pricing-schemas.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/tool/pieces.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
	...
	<span class="circle"></span>
	<?php		
	$url_str =  $ste_root."manage/reports/reports-landing.php";
	$url_str = preg_replace('/(\/+)/','/',$url_str);
