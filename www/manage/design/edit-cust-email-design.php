...
$page_title = "Edit Customer Email in Design Request";
$page_group = "design";
...
$db = $dbCustom->getDbConnect(SITE_N_DATABASE);
        ...
        $sql = "SELECT design_email_content_id
			...
			WHERE design_email_content_id = (SELECT MAX(design_email_content_id) FROM design_email_content WHERE profile_account_id = '".$_SESSION['profile_account_id']."')";
...
<div class="manage_page_container">
	...
	<div class="manage_main">
		...
		<form name="edit_part" action="<?php echo $url_str;  ?>" method="post" onSubmit="return validate(this)"  enctype="multipart/form-data">
			...
			<input type="hidden" name="design_email_content_id" value="<?php echo $object->design_email_content_id; ?>" />
