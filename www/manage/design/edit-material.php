...
$sql = "SELECT material_name	
				...
				,saas_id	
		FROM material 
		WHERE material_id = '".$_SESSION['material_id']."'";
...
if($result->num_rows > 0){
	...
	$material_type_id = $object->material_type_id;
	$mat_color = $object->mat_color;
	$mat_alpha = $object->mat_alpha;
	$mat_image = $object->mat_image;
	$saas_id = $object->saas_id;
...
if(!isset($_SESSION['temp_fields']['material_name'])) $_SESSION['temp_fields']['material_name'] = $material_name;

if(!isset($_SESSION['temp_fields']['tier_id'])) $_SESSION['temp_fields']['tier_id'] = $tier_id;

if(!isset($_SESSION['temp_fields']['material_type_id'])) $_SESSION['temp_fields']['material_type_id'] = $material_type_id;


if(!isset($_SESSION['temp_fields']['mat_color'])) $_SESSION['temp_fields']['mat_color'] = $mat_color;

if(!isset($_SESSION['temp_fields']['mat_alpha'])) $_SESSION['temp_fields']['mat_alpha'] = $mat_alpha;

if(!isset($_SESSION['temp_fields']['mat_image'])) $_SESSION['temp_fields']['mat_image'] = $mat_image;
