...
if(strpos($_SERVER['REQUEST_URI'], 'localhost/onlinecl' )){  
...
<div class="manage_page_container">
	...
	<div class="manage_main">
		...
		if(!$strip){ 
			...
			$bread_crumb->reSet();
			$bread_crumb->add("Tool Settings", $ste_root."manage/catalog/catalog-landing.php");
        ...
        require_once($_SERVER['DOCUMENT_ROOT']."/manage/admin-includes/tool-section-tabs.php");
