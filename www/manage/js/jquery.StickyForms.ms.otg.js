...
function deleteStickyCookies(){

	var splitCookie
	$.each(document.cookie.split(/; */), function()  {
		splitCookie = this.split('=');
		if(splitCookie[0].indexOf("StickyForm") > -1){
			document.cookie = splitCookie[0]+'=; path=/; expires=' + new Date(0).toUTCString();
		  	//alert(splitCookie[0]);		 
		  }
	});
