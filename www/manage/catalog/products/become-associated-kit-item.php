...
$page_title = 'Become Associated Kit Product';
$page_group = 'item';
...
<div class="manage_page_container">
	...
	$url_str = preg_replace('/(\/+)/','/',$url_str);
        ...
        <input type="submit" name="become_associated" value="Submit">
    		...
    		<div class="data_table clearfix">
            	...
            	<table cellpadding="10" cellspacing="0">
					...
					while($row = $result->fetch_object()){
						...
						$block .= "<input type='checkbox' class='checkboxinput' name='kit_item_ids[]' value='".$row->item_id."'/></div>";
						$block .= "</div>";
						$block .= "</td></tr>";
