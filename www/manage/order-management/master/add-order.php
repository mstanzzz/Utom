...
if(!isset($_SESSION['temp_order_fields'])){
	...
	$_SESSION['temp_order_fields']['order_date'] = time();
	$_SESSION['temp_order_fields']['shipping_name'] = '';
	$_SESSION['temp_order_fields']['shipping_name_company'] = '';
	$_SESSION['temp_order_fields']['shipping_address_one'] = '';
	$_SESSION['temp_order_fields']['shipping_address_two'] = '';
	$_SESSION['temp_order_fields']['shipping_city'] = '';
	$_SESSION['temp_order_fields']['shipping_state'] = '';
	$_SESSION['temp_order_fields']['shipping_zip'] = '';
	$_SESSION['temp_order_fields']['shipping_country'] = '';
	$_SESSION['temp_order_fields']['shipping_phone'] = '';
	$_SESSION['temp_order_fields']['shipping_email'] = '';
	$_SESSION['temp_order_fields']['billing_name'] = '';
	$_SESSION['temp_order_fields']['billing_email'] = '';
	$_SESSION['temp_order_fields']['billing_address_one'] = '';
	$_SESSION['temp_order_fields']['billing_address_two'] = '';
	$_SESSION['temp_order_fields']['billing_city'] = '';
	$_SESSION['temp_order_fields']['billing_state'] = '';
	$_SESSION['temp_order_fields']['billing_zip'] = '';
	$_SESSION['temp_order_fields']['billing_country'] = '';
	$_SESSION['temp_order_fields']['billing_phone'] = '';
	$_SESSION['temp_order_fields']['in_house_product_descr'] = '';
	$_SESSION['temp_order_fields']['sub_total'] = 0;
	
	$_SESSION['temp_order_fields']['shipping_cost'] = 0;
	$_SESSION['temp_order_fields']['tax_cost'] = 0;
	
	$_SESSION['temp_order_fields']['customer_id'] = 0;
	
	$_SESSION['temp_order_fields']['line_item_array'] = array();
...
function validate(){
	...
	document.add_order_form.submit();	
...
<div class="manage_page_container">
    ...
    <form  name="add_order_form" action="<?php echo $url_str; ?>" method="post" 
