...
<div style="float:right; clear:both;"><a href="order-print-view.php<?php echo $url_str; ?>" class="btn btn-small">Print</a></div>
	...
	<div class="manage_form_left_label">Order Type</div> 
	<div class="manage_form_right_info">
	<?php
	echo $object->order_type;   
	if($object->order_type == 'manual' || $object->order_type == 'legacy'){
	...
	<div class="manage_form_right_info"><?php echo $object->transaction_id; ?></div> 
	<div class="clear"></div>
	...
	<div class="manage_form_left_label">Manual Product Description</div> 
	<div class="manage_form_right_info"><?php echo $object->in_house_product_descr; ?></div> 
	<div class="clear"></div>
...
?>
	...
	while($row = $result->fetch_object()){						
		...
		if($row->order_state_id == 7){
			...
			$block .= "<td valign='top'><a href='".$url_str."' class='btn btn-small'>Enter or edit shipping information and email customer</a></td>";
