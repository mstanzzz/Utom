        		...
        		<table cellpadding="10" cellspacing="0">
					<thead>
						<tr>
            				...
            				<th <?php addSortAttr('trans_date',true); ?>>
                            Transaction Date
                            <i <?php addSortAttr('trans_date',false); ?>></i>
                            </th>
            				<th <?php addSortAttr('amount',true); ?>>
                            Order Total
...
<?php
    ...
    while($row = $result->fetch_object()) {
		...
		$block .= "<td>";
		$block .= "<a href='order.php?order_id=".$row->order_id."' class='btn btn-small'><i class='icon-eye-open'></i> Order Details</a>";
		$block .= "</td>";

		$block .= "<td>";
		$block .= "<a href='transaction.php?order_id=".$row->order_id."' class='btn btn-small btn-primary'><i class='icon-eye-open icon-white'></i> View Tranaction</a>"; 
		$block .= "</td></tr>";
