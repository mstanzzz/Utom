...
<div class="manage_page_container">
	...
	<?php 
		...
		$bread_crumb->add("Add Keyword Landing Page", '');
		...
		<input type="hidden" name="ret_page" value="add-ketword-landing">
            ...
            <fieldset>
				...
				<table cellpadding="10" cellspacing="0">
					...
					foreach($_SESSION['temp_page_fields']['temp_docs'] as $val) {
						...
						$block .= "<td valign='middle'><a class='btn btn-danger save_session' href='add-keyword-landing.php?remove_doc=1&doc_id=".$val['doc_id']."'>";						
...
<div id="content-delete" class="confirm-content">
	...
	<form name="del_tab" action="add-keyword-landing.php" method="post" >
