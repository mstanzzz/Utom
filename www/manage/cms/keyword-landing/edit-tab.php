...
$tab_text = $_SESSION['temp_page_fields']['temp_tabs'][$indx]['tab_text'];
$content = $_SESSION['temp_page_fields']['temp_tabs'][$indx]['content'];
...
<div class="lightboxholder">
	...
	<form name="form" action="<?php echo $ret_page.'.php'; ?>" method="post" enctype="multipart/form-data" target='_top'>
	    <input type="hidden" name="edit_tab" value="1" />
		...
		<br /><br />
	<div class="savebar">
		<button class="btn btn-large btn-success" name="eit_tab_btn" type="submit"><i class="icon-ok icon-white"></i> Update Tab </button>
