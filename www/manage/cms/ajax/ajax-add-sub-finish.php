...
/*
echo "<br />finish_name:  ".$finish_name;
echo "<br />tool_color:  ".$tool_color;
echo "<br />type_id:  ".$type_id;
echo "<br />tool_alpha:  ".$tool_alpha;
echo "<br />tool_image:  ".$tool_image;
*/
	...
	$stmt = $db->prepare("INSERT INTO finishes
						(finish_name
						,tool_color						
						,tool_image
						,tool_alpha
