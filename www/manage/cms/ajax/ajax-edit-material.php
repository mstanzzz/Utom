...
$_SESSION['material_id'] = isset($_GET['material_id'])? $_GET['material_id'] : 0;
...
$sql =  sprintf("SELECT	material_name
				...
				,qty_calc_id
		FROM materials
		WHERE material_id = %u", $_SESSION['material_id']);
$result = $dbCustom->getResult($db,$sql);
...
$eb_ids = getEbidsArray($_SESSION['material_id']);
...
$result = $dbCustom->getResult($db,$sql);
$panel_brand_array = array();		
$i = 0;
while($row = $result->fetch_object()){
	$panel_brand_array[$i]['panel_brand_id'] = $row->panel_brand_id;
	$panel_brand_array[$i]['panel_brand_name'] = $row->panel_brand_name; 
	$i++;
}	
*/
...
<div style="position:absolute; top:80px; left:10%; width:1000px;">
...
<form action="material.php" method="post" enctype="multipart/form-data" onsubmit="return validate(this);">
<input type="hidden" name="update_material" value="1" />
<input type="hidden" name="material_id" value="<?php echo $_SESSION['material_id']; ?>" />

<div class="container modal-tool-admin modal-edit-edge clearfix modal-add-new-material" style="float:right;">
	<div class="clearfix">
		<div class="left-side">
            ...
            <div class="clearfix edit-unit-detail-label">
                ...
                <input type="text" class="input-border-bottom modal-normal-input input-italic"
            ...
            <div>
                <select multiple id="edit_eb_ids" name="eb_ids[]" class="rounded-select" size="1" onChange="expand_select(this,<?php echo count($edge_banding_array); ?>)">
        ...
        <div id="mat_swiches_edit">
        	<div class="clearfix edit-unit-detail-label">
				...
				<div class="add-on-checkbox-item clearfix">
                    ...
                    <label class="switch">
                    <input type="checkbox" id="edit_material_stocked" name="material_stocked" <?php if($material_stocked) echo "checked"; ?>>
                    <span class="switch-slider round"></span>
                    </label>
				</div>
			</div>
        ...
        <tr>
            ...
            <td>
                <select id="edit_core_id" name="core_id" class="rounded-select" style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
            ...
            <td>
                <button  type="button"
	                onClick="open_modal_by_id('modify_core');" 
    	            class="btn-default btn-small text-capitalize with-bottom-shadow btn-with-border btn-bold btn-italic btn-modify">
        		        Cores
                </button>
            </td>
		...
		<tr>
            ...
            <td>
                <select id="edit_type_id" name="type_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
        ...
        <tr>
            ...
            <td>
                <select id="edit_finish_id" name="finish_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
        ...
        <tr>
			...
			<td>
                <select id="edit_texture_id" name="texture_id" class="rounded-select"  style="width:140px;">
                	<option value="0">Select Options</option>
					<?php
        ...
        <tr>
            ...
            <td>
                <select id="edit_tier_id" name="tier_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
            ...
            <td>
                <button  type="button"
	                onClick="open_modal_by_id('modify_material_tier');" 
    	            class="btn-default btn-small text-capitalize with-bottom-shadow btn-with-border btn-bold btn-italic btn-modify">
        		        Mat. Tiers
                </button>
            </td>
		...
		<tr>
            ...
            <td>
                <select id="edit_hanging_bracket_cover_color_id" name="hanging_bracket_cover_color_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
            ...
            <td>    
                <button  type="button"
	                onClick="open_modal_by_id('modify_color');" 
    	            class="btn-default btn-small text-capitalize with-bottom-shadow btn-with-border btn-bold btn-italic btn-modify">
        		        Colors
                </button>
            </td>
		...
		<tr>
            ...
            <td>
                <select id="edit_rail_cover_color_id" name="rail_cover_color_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
                    foreach($color_array as $val){
		...
		<tr>
            ...
            <td>
                <select id="edit_kd_fitting_color_id" name="kd_fitting_color_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
                    foreach($color_array as $val){
		...
		<tr>
            ...
            <td>
                <select id="edit_qty_calc_id" name="qty_calc_id" class="rounded-select"  style="width:140px;">
                    <option value="0">Select Options</option>
                    <?php
    ...
    <div class="container-btn-bottom">
        ...
        <span onclick="close_modal_edit_material();" class="modal-close">Cancel</span>
	</div>
</div>
</div>
</div>
    ...
    Not Used For Now
            ...
            <div id="rtf_box_edit" class="add-new-material-green-container" 
            	style="position:relative; left:1%; height:320px; visibility:hidden;">
                
                <b>RTF Detail</b>
                <div class="clearfix edit-unit-detail-label">
                    <label class="modal-tool-admin-label">RTF Name</label>
                    <input type="text" id="rtf_name" name="rtf_name" class="input-border-bottom modal-normal-input" >
                </div>
                <div class="clearfix edit-unit-detail-label">
                    <label class="modal-tool-admin-label">SKU Number</label>
                    <input type="text" class="input-border-bottom modal-normal-input" >
                </div>
                <table class="edit-edge-table">
					<tbody>
                    	<tr>
							...
							<td>
                            <select name="rtf_brand_id" class="rounded-select">
                                <option value="0">Select Options</option>
                                <?php
                                //foreach($edge_banding_array as $val){
                                //echo "<option value='".$val['panel_brand_id']."'>".$val['panel_brand_name']."</option>";	
                                //}
                                
                                foreach($brand_array as $val){
									$sel = ($rtf_brand_id = $val['brand_id'])? "selected" : '';
                                	echo "<option value='".$val['brand_id']."' $sel>".$val['name']."</option>";	
                                }
                                ?>
                            </select>
							...
							<td>
                                        <button  type="button"
                                            onClick="open_modal_by_id('brands');" 
                                            class="btn-default btn-small text-capitalize with-bottom-shadow btn-with-border btn-bold btn-italic btn-modify">
                                                Brands
                                        </button>
							</td>
                        ...
                        <tr>
							...
							<td>
                            <select name="rtf_vendor_id" class="rounded-select">
                                <option value="0">Select Options</option>
                                <?php
                                foreach($vend_man_array as $val){
                                $sel = ($rtf_vendor_id = $val['vend_man_id'])? "selected" : '';												
                                echo "<option value='".$val['vend_man_id']."' $sel>".$val['name']."</option>";	
                                }
                                ?>
                            </select>
							...
							<td>
                                            <button  type="button"
                                                onClick="open_modal_by_id('vendors');" 
                                                class="btn-default btn-small text-capitalize with-bottom-shadow btn-with-border btn-bold btn-italic btn-modify">
                                                    Vendors
                                            </button>
							</td>
                ...
                <div class="container-btn-bottom">
					<span>Reset</span>
                        <button onclick="show_rtf_box();"  class="btn-default btn-bold text-capitalize with-bottom-shadow btn-with-border">
                           Add RTF Detail
                        </button>
    				<span onclick="hide_rtf_box_edit();">Cancel</span>
				</div>
            </div>



            <div id="hpl_box_edit" class="add-new-material-green-container" 
            	style="position:relative; left:1%; top:-6px; height:320px; visibility:hidden;">
                <b>HPL Detail</b>
                <div class="clearfix edit-unit-detail-label">
                    <label class="modal-tool-admin-label">HPL Name</label>
                    <input type="text" id="hpl_name" name="hpl_name" class="input-border-bottom modal-normal-input" >
                </div>
                <div class="clearfix edit-unit-detail-label">
                    <label class="modal-tool-admin-label">SKU Number</label>
                    <input type="text" class="input-border-bottom modal-normal-input" >
                ...
                <table class="edit-edge-table">
					<tbody>
                    	<tr>
							...
							<td>
                            <select name="hpl_brand_id" class="rounded-select">
                                <option value="0">Select Options</option>
                                <?php
                                //foreach($edge_banding_array as $val){
                                //echo "<option value='".$val['panel_brand_id']."'>".$val['panel_brand_name']."</option>";	
                                ...
                                foreach($brand_array as $val){
									$sel = ($hpl_brand_id = $val['brand_id'])? "selected" : '';
                                	echo "<option value='".$val['brand_id']."' $sel>".$val['name']."</option>";	
                                }
                                ?>
                            </select>
                        ...
                        <tr>
							...
							<td>
                            <select name="hpl_vendor_id" class="rounded-select">
                                <option value="0">Select Options</option>
                                <?php
                                foreach($vend_man_array as $val){
                                $sel = ($hpl_vendor_id = $val['vend_man_id'])? "selected" : '';												
                                echo "<option value='".$val['vend_man_id']."' $sel>".$val['name']."</option>";	
                                }
                                ?>
                            </select>
                ...
                <div class="container-btn-bottom">
					<span>Reset</span>
                        <button onclick="show_hpl_box();"  class="btn-default btn-bold text-capitalize with-bottom-shadow btn-with-border">
                           Add HPL Detail
                        </button>
    				<span onclick="hide_hpl_box_edit();">Cancel</span>
				</div>
            </div>
