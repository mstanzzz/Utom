...
<div class="modal-tool-admin modal-edit-edge clearfix">
	<div class="clearfix">
		...
		<div class="clearfix edit-unit-detail-label">
            ...
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_eb_name" name="eb_name" value="<?php echo $eb_name; ?>"
            placeholder="Required"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Vendor Product #</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_vend_prod_num" name="vend_prod_num" value="<?php echo $vend_prod_num; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Stocked</label>
            <label class="switch">
            <input type="checkbox" id="edit_sub_eb_is_stocked" name="is_stocked" value="1" <?php if($is_stocked > 0) echo "checked"; ?>>
            <span class="switch-slider round"></span>
            </label>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Cost Per Roll</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_cost_per_roll" name="cost_per_roll" value="<?php echo $cost_per_roll; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Markup</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_markup" name="markup" value="<?php echo $markup; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Glue Cost</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_glue_cost" name="glue_cost" value="<?php echo $glue_cost; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Waste Allowance</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_waste_allowance" name="waste_allowance" value="<?php echo $waste_allowance; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Roll Lenght</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_eb_roll_length" name="eb_roll_length" value="<?php echo $eb_roll_length; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Thickness</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_eb_thickness" name="eb_thickness" value="<?php echo $eb_thickness; ?>"/>
        </div>
        <div class="clearfix edit-unit-detail-label">
            <label class="modal-tool-admin-label">Width</label>
            <input type="text" class="input-border-bottom modal-normal-input" id="edit_sub_eb_eb_width" name="eb_width" value="<?php echo $eb_width; ?>"/>
        </div>
        </div>
		...
		<table class="edit-edge-table">
			...
			<tr>
                ...
                <td>
                    <select id="edit_sub_eb_finish_id" name="finish_id" class="rounded-select" style="width:200px;">
			...
			<tr>
                ...
                <td>
                    <select id="edit_sub_eb_texture_id" name="texture_id" class="rounded-select" style="width:200px;">
                        <option value="0">Select Options</option>
                        <?php
            ...
            <tr>
                <td>
                 ...
                 <td>
                    <select id="edit_sub_eb_brand_id" name="brand_id" class="rounded-select" style="width:200px;">
                        <option value="0">Select Options</option>
                        <?php
            ...
            <tr>
                ...
                <td>
                    <select id="edit_sub_eb_vendor_id" name="vendor_id" class="rounded-select" style="width:200px;">
                        <option value="0">Select Options</option>
                        <?php
        ...
        <div class="container-btn-bottom">
            <button type="button" 
                ...
                onClick="update_sub_ed(<?php echo $eb_id ?>)">
            Save
            </button>
            <span class="modal-close" onClick="close_sub_edit_eb();">Cancel</span>
        </div>
		</div>
	</div>
</div>
