...
if($_SESSION['tool_image'] != '') $_SESSION['tmp_vars']['part_image'] = $_SESSION['tool_image'];             
if($_SESSION['thumb_image'] != '') $_SESSION['tmp_vars']['thumb_image'] = $_SESSION['thumb_image']; 
...
?>
    ...
    <div class="modal-tool-admin clearfix">
        <div class="clearfix">
    	<p class="modal-tool-admin-title">Edit Constructed Part</p>
		 <form id="upload_sub_form_thumb_edit"  method="post" enctype="multipart/form-data">
			<div class="file-container btn-default btn-mint-border" style="width:192px;">
				...
				<input type="file" name="uploadedfile" id="uploadedfile" onchange="submit_edit_sub_constructed_part_upload(0,<?php echo $_SESSION['part_id']; ?>);">
			</div>
		</form>
        <br />
        <form id="upload_sub_form_main_edit"  method="post" enctype="multipart/form-data">				
			<div class="file-container btn-default btn-mint-border" style="width:192px;">
				<label class="modal-tool-admin-label">Select New Image File</label>
				<input type="file" name="uploadedfile" id="uploadedfile" onchange="submit_edit_sub_constructed_part_upload(1,<?php echo $_SESSION['part_id']; ?>);">
			</div>
 		</form>
		</div>
    <br />
    ...
    <div class="clearfix">
        <div class="left-side">
            <div class="separator-text-input">
                ...
                id="edit_sub_cp_part_name" name="part_name"  
                value="<?php echo $_SESSION['tmp_vars']['part_name']; ?>" placeholder="Required"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Image</label>
                <input type="text" class="input-border-bottom" 
                id="edit_sub_cp_part_image" name="part_image" value="<?php echo $_SESSION['tmp_vars']['part_image']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Image Thumbnail</label>
                <input type="text" class="input-border-bottom" 
                id="edit_sub_cp_thumb_image" name="thumb_image" value="<?php echo $_SESSION['tmp_vars']['thumb_image']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part SKU</label>
                <input type="text" class="input-border-bottom" 
                id="edit_sub_cp_part_sku" name="part_sku"  value="<?php echo $_SESSION['tmp_vars']['part_sku']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Number</label>
                <input type="text" class="input-border-bottom" 
                id="edit_sub_cp_part_number" name="part_number" value="<?php echo $_SESSION['tmp_vars']['part_number']; ?>"/>
            </div>
            <div class="separator-text-input">
                ...
                id="edit_sub_cp_part_weight" name="part_weight" value="<?php echo $_SESSION['tmp_vars']['part_weight']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Width</label>
                <input type="text" class="input-border-bottom modal-normal-input" 
                id="edit_sub_cp_width" name="width"  value="<?php echo $_SESSION['tmp_vars']['width']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Height</label>
                <input type="text" class="input-border-bottom modal-normal-input" 
                id="edit_sub_cp_height" name="height" value="<?php echo $_SESSION['tmp_vars']['height']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Depth</label>
                <input type="text" class="input-border-bottom modal-normal-input" 
                id="edit_sub_cp_depth" name="depth" value="<?php echo $_SESSION['tmp_vars']['depth']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Width Offset</label>
                <input type="text" class="input-border-bottom modal-normal-input" 
                id="edit_sub_cp_width_offset" name="width_offset" value="<?php echo $_SESSION['tmp_vars']['width_offset']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Height Offset</label>
                <input type="text" class="input-border-bottom  modal-normal-input" 
                id="edit_sub_cp_height_offset" name="height_offset" value="<?php echo $_SESSION['tmp_vars']['height_offset']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Part Depth Offset</label>
                <input type="text" class="input-border-bottom"
                id="edit_sub_cp_depth_offset"  name="depth_offset" value="<?php echo $_SESSION['tmp_vars']['depth_offset']; ?>"/>
            </div>
            <div class="separator-text-input">
                <label class="modal-tool-admin-label unit-label">Description</label>
                <input type="text" class="input-border-bottom modal-normal-input"
                id="edit_sub_cp_description" name="description" value="<?php echo $_SESSION['tmp_vars']['description']; ?>"/>
            </div>
        </div>
        <div class="right-side">
            <div class="label-with-dropdown label-with-dropdown-separator clearfix">
	            <label>Part Type</label>
                <select id="edit_sub_cp_part_type_id" name="part_type_id" onchange="set_sub_const_part_dimensions(this,'add');"
            ...
            <div class="label-with-dropdown label-with-dropdown-separator clearfix">
                ...
                <select id="edit_sub_cp_material_id" name="material_id" 
                class="btn-default btn-small with-small-bottom-shadow with-small-dropdown" 
                style="padding:4px; width:126px; margin-top:2px">              
                <option value="0">Select</option>    
                <?php
            ...
            <div class="label-with-dropdown label-with-dropdown-separator clearfix">
                ...
                <select id="edit_sub_cp_price_schema_id"  name="price_schema_id" 
                class="btn-default btn-small with-small-bottom-shadow with-small-dropdown" 
                style="padding:4px; width:126px; margin-top:2px;">              
                <option value="0">Select</option>    
                <?php
            ...
            <div class="label-with-dropdown label-with-dropdown-separator clearfix">
                ...
                <select id="edit_sub_cp_qty_schema_id"  name="qty_schema_id" 
                class="btn-default btn-small with-small-bottom-shadow with-small-dropdown" 
                style="padding:4px; width:126px; margin-top:2px;">              
                <option value="0">Select</option>    
                <?php
            ...
            <div class="label-with-dropdown label-with-dropdown-separator clearfix">
                ...
                <select id="edit_sub_cp_qty_calc_id" name="qty_calc_id" 
                class="btn-default btn-small with-small-bottom-shadow with-small-dropdown" 
                style="padding:4px; width:126px; margin-top:2px;">              
                <option value="0">Select</option>    
                <?php
            ...
            <div class="label-with-dropdown clearfix">
                ...
                <select id="edit_sub_cp_swg_id"  name="swg_id" 
                class="btn-default btn-small with-small-bottom-shadow with-small-dropdown" 
                style="padding:4px; width:126px; margin-top:2px;">              
                <option value="0">Select</option>    
                <?php
    ...
    <div class="container-btn-bottom">
        ...
        <button 
            ...
            onclick="update_sub_constructed_part(<?php echo $_SESSION['part_id']; ?>);">
        Save
        </button>
        <span class="modal-close" onclick="close_sub_edit_constructed_part();">Cancel</span>
        </div>
    </div>