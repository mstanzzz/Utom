...
if(!isset($_SESSION['temp_istallation_link_fields']['button_text'])) $_SESSION['temp_istallation_link_fields']['button_text'] = '';
if(!isset($_SESSION['temp_istallation_link_fields']['page_seo_id'])) $_SESSION['temp_istallation_link_fields']['page_seo_id'] = 0;
if(!isset($_SESSION['temp_istallation_link_fields']['color'])) $_SESSION['temp_istallation_link_fields']['color'] = "blue";

if(!isset($_SESSION['temp_istallation_link_fields']['local_url'])) $_SESSION['temp_istallation_link_fields']['local_url'] = '';
...
<div class="lightboxcontent">
	...
	<div class="colcontainer formcols">
		...
		$result = $dbCustom->getResult($db,$sql);				
            ...
            $url_str .= "?ret_page=add-installation-link";
...
<div class="savebar">
    ...
    <div style="float:left;">
    	<button class="btn btn-large btn-success" name="add_installation_link" type="submit"><i class="icon-ok icon-white"></i> Save Changes </button>
	</div>
    <div class="clear"></div>
