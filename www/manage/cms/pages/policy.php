    ...
    <div class="manage_main">
		...
		<form name="form" action="policy.php" method="post" enctype="multipart/form-data">
            ...
            <!--<a onClick="previewSubmit();" href="#" class="btn btn-primary btn-large"><i class="icon-eye-open icon-white"></i> Preview </a>-->
				...
				<a href="<?php echo SITEROOT;?>/manage/cms/pages/page.php" class="btn btn-large"><i class="icon-arrow-left"></i> Cancel </a>
...
?>
                        ...
                        ?>
                            ...
                            href="<?php echo SITEROOT;?>/manage/cms/upload.php?ret_page=policy&ret_dir=pages&img_max_width=450">
				...
				$result = $dbCustom->getResult($db,$sql);						
						while($row = $result->fetch_object()) {
							...
							if($img_res->num_rows > 0){
								...
								$block .= "<td valign='middle'><img src='".SITEROOT."/saascustuploads/".$_SESSION['profile_account_id']."/cms/".$img_obj->file_name."' 
