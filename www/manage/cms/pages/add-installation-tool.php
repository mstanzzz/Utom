...
$page_title = "Add New Installation Tool";
...
if(!isset($_SESSION['temp_page_fields']['display_order'])) $_SESSION['temp_page_fields']['display_order'] = 1;
	...
	<form name="form" action="installation-tools.php" method="post" target="_top">
		...
		<div class="lightboxcontent">
			...
			<fieldset>
				...
				<div class="colcontainer">
                    ...
                    <div class="twocols"> 
                        ...
                        $url_str .= "?ret_page=add-installation-tool";
			...
			<fieldset>
				...
				<textarea cols="88" id="description" name="description"><?php echo $_SESSION['temp_page_fields']['description'] ?></textarea>
			</fieldset>
		</div>
		<div class="savebar">
			<button class="btn btn-large btn-success" name="add_installation_tool" type="submit"><i class="icon-ok icon-white"></i> Save Changes </button>
		</div>
	</form>
</div>
</body>
