...
echo "<br />";
echo "p_2_text: ".$p_2_text."<br />";
echo "<br /> temp_page_fields  p_2_text  ".$_SESSION['temp_page_fields']['p_2_text'];
echo "<br />";
exit;
*/
...
<a onClick="test();">HHHHHHHHHHHHH</a>
...
<div class="manage_page_container">
	...
	<form name="form" action="<?php echo $current_page; ?>" method="post" enctype="multipart/form-data">
		<input type="hidden" name="update_about_us" value="1">        
...
<a onClick="testing();">HHHHHHHHHHHHH</a>

<label>p_1_text</label>
<textarea class="wysiwyg" name="p_1_text"> p_1_text </textarea>
