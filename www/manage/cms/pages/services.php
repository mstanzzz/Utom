...
// add if not exist
$sql = "SELECT services_id FROM services WHERE profile_account_id = '".$_SESSION['profile_account_id']."'"; 
...
if(!is_numeric($_SESSION['services_id'])) $_SESSION['services_id'] = 0;
...
if(isset($_POST['update_services'])){
	...
	$top_4 = isset($_POST['top_4'])? addslashes(trim($_POST['top_4'])) : '';

	$service_1_text = isset($_POST['service_1_text'])? addslashes(trim($_POST['service_1_text'])) : '';
	$service_2_text = isset($_POST['service_2_text'])? addslashes(trim($_POST['service_2_text'])) : '';
	$service_3_text = isset($_POST['service_3_text'])? addslashes(trim($_POST['service_3_text'])) : '';
	$service_4_text = isset($_POST['service_4_text'])? addslashes(trim($_POST['service_4_text'])) : '';
	...
	$_SESSION['temp_page_fields']['top_4'] = $top_4;	
	$_SESSION['temp_page_fields']['service_1_text'] = $service_1_text;	
	$_SESSION['temp_page_fields']['service_2_text'] = $service_2_text;	
	$_SESSION['temp_page_fields']['service_3_text'] = $service_3_text;	
	$_SESSION['temp_page_fields']['service_4_text'] = $service_4_text;	
	...
	if(!$stmt->bind_param("ssssssssssssssssssssssssssi"
						,$top_1
						,$top_2
						,$top_3
						,$top_4
...
$sql = "SELECT *
FROM services 
WHERE services_id = '".$_SESSION['services_id']."'";
$result = $dbCustom->getResult($db,$sql);	
if($result->num_rows > 0){
	$object = $result->fetch_object();
	...
	$service_1_text = $object->service_1_text;
	$service_2_text = $object->service_2_text;
	$service_3_text = $object->service_3_text;
	$service_4_text = $object->service_4_text;
...
if(!isset($_SESSION['temp_page_fields']['top_4'])) $_SESSION['temp_page_fields']['top_4'] = $top_4;
if(!isset($_SESSION['temp_page_fields']['service_1_text'])) $_SESSION['temp_page_fields']['service_1_text'] = $service_1_text;
if(!isset($_SESSION['temp_page_fields']['service_2_text'])) $_SESSION['temp_page_fields']['service_2_text'] = $service_2_text;
if(!isset($_SESSION['temp_page_fields']['service_3_text'])) $_SESSION['temp_page_fields']['service_3_text'] = $service_3_text;
if(!isset($_SESSION['temp_page_fields']['service_4_text'])) $_SESSION['temp_page_fields']['service_4_text'] = $service_4_text;
...
<div class="manage_page_container">
	...
	<div class="manage_main"> 
		...
		<input type="hidden" name="services_id" value="<?php echo $_SESSION['services_id']; ?>">
...
<label>top_4</label>
<input type="text" name="top_4"  style="width:520px" value="<?php echo stripslashes($_SESSION['temp_page_fields']['top_4']); ?>">

<label>service_1_text (In-home design consultation)</label>
<textarea id="service_1_text" class="wysiwyg" name="service_1_text"><?php echo stripslashes($_SESSION['temp_page_fields']['service_1_text']); ?></textarea>


<label>service_2_text (Online design request (AKA Virtual design))</label>
<textarea id="service_2_text" class="wysiwyg" name="service_2_text"><?php echo stripslashes($_SESSION['temp_page_fields']['service_2_text']); ?></textarea>

<label>service_3_text (Online design request (Pre-Assembly service))</label>
<textarea id="service_3_text" class="wysiwyg" name="service_3_text"><?php echo stripslashes($_SESSION['temp_page_fields']['service_3_text']); ?></textarea>


<label>service_4_text (Installation and Virtual showroom tour)</label>
<textarea id="service_4_text" class="wysiwyg" name="service_4_text"><?php echo stripslashes($_SESSION['temp_page_fields']['service_4_text']); ?></textarea>
