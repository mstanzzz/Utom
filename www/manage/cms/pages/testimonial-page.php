	...
	<div class="manage_main">
		...
		<form name="form" action="testimonial-page.php" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="edit_content">
				...
				<div class="threecols">
					<?php 
						echo "<img src='".SITEROOT."/ul_cms/".SITEROOT."/".$img_row->file_name."' width='120px' onClick='select_img(".$img_row->img_id.")' />"; 
            ...
            href="<?php echo SITEROOT;?>/manage/cms/upload.php?ret_page=testimonial-page&ret_dir=pages&img_max_width=450">
