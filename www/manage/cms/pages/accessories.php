...
$_SESSION['accessories_id'] = isset($_GET['accessories_id'])? $_GET['accessories_id'] : 0; 
if(!is_numeric($_SESSION['accessories_id'])) $_SESSION['accessories_id'] = 0;

$msg = (isset($_GET['msg'])) ? $_GET['msg'] : '';

if(isset($_POST['update_accessories'])){

	$_SESSION['accessories_id'] = isset($_POST['accessories_id'])? $_POST['accessories_id'] : 0;
	if(!is_numeric($accessories_id)) $accessories_id = 0;
...
<a class="btn btn-info" href="<?php echo $url_str; ?>">Upload Hero Image </a>
	...
	<form name="form" action="accessories.php" method="post" enctype="multipart/form-data">
		<input type="hidden" name="update_accessories" value="1">        
