...
<html lang="en">
	...
	<meta name="description" content="Account idea folder"><link href="app.css" rel="stylesheet"></head>
	<body>
											...
											<figure class="my-house__wrapper">
												<figcaption class="my-house__content">
													...
													<div class="my-house__img--group">
														...
														<a href="account-idea-folder-details.php" class="my-house__link-fixed mobile-show"></a>

														<div class="my-house__img--text">
															
															<a href="account-idea-folder-details.php" class="my-house__link-fixed"></a>
													...
													<a  href="account-idea-folder-details.php" class="my-house__heading">Title house name 1</a>
												</figcaption>
											</figure>
										</div>
										<div class="col-6 col-lg-4">
									...
									<div class="col-12 col-lg-4 mb-2">
										<div class="account-block__form--house-image">
											...
											<a href="" data-lightbox="roadtrip" data-title="Lorem ipsum">
												<img src="xxxHTMLLINKxxx0.0242654720692188080.7917992898801613xxx" alt="" class="js-my-house-img-view img-fluid" style="display: none;">
											</a>
										</div>
									</div>
									<div class="col-12 col-lg-4 mb-2">
						...
						<h5 class="modal-title manage-house-tite" id="manageHousesTitle">My houses
							...
							<div class="manage-house-filters">
								...
								<div class="manage-house-filters__result"  style="display: none;">
									...
									<button class="manage-house-filters__result--button js-manage-house-delete" data-toggle="modal" data-target="#deleteHouse">
