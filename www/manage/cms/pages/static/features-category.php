...
<html lang="en">
	...
	<meta name="description" content="Features Category page"><link href="app.css" rel="stylesheet"></head>
	<body class="product-detail specification-page">
		...
		<section class="first-fixed-block covid-block clearfix">
			<figure class="first-fixed-block__img-group" style="background-image: url('images/features-category-header.jpg');">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Features category</li>
									</ul>
								</div>
							</div>
						</div>
									...
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading text-center">Features category</h2>
											</div>
										</div>
									</div>
									<div class="row">
