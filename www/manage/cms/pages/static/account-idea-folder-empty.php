...
<html lang="en">
	...
	<meta name="description" content="Account idea folder empty"><link href="app.css" rel="stylesheet"></head>
	<body>
						...
						<div class="row">
							...
							<div class="col-12 col-lg-9">
									...
									<div class="account-block__general-info--details desktop-show">
										...
										<div class="row">
											<div class="col-12 desktop-show">
												<div class="account-block__buttons-block mt-4 mb-0">
								...
								<div class="account-block__details idea-folder active" id="my-houses">
									<div class="row">
										<div class="col-12">
											<p class="idea-folder-empty-house__heading">No houses!</p>
											<p class="idea-folder-empty-house__text">You can add houses by choosing above option "Add hose"</p>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-12 col-lg-4 mb-2">
										<div class="account-block__form--house-image">
											...
											<a href="" data-lightbox="roadtrip" data-title="Lorem ipsum">
												<img src="xxxHTMLLINKxxx0.45183294730898280.7507461113417506xxx" alt="" class="js-my-house-img-view img-fluid" style="display: none;">
											</a>
										</div>
									</div>
									<div class="col-12 col-lg-4 mb-2">
