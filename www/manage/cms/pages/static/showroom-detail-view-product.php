...
<html lang="en">
   ...
   <meta name="description" content="Showroom detail view product"><link href="./app.css" rel="stylesheet"></head>
					...
					<div class="row">
						<div class="col-12">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="showroom-detail-view.html" title="">Master closet Organizers</a></li>
                     ...
                     <div class="col-12 col-lg-6">
                        <div class="caro-wrap js-switch-carosel-mobile-wrap">
							...
							<div class="showroom-detail-product__carousel-nav">
								<div>
									<img src="images/img-video.png" alt="" class="img-fluid prod-detail__nav-img">
								</div>
								<div>
													...
													<div class="col-12">
														...
														<div class="card-feature tab--feaures_nd" data-select="feature-item">
															...
															<div class="card-feature__img a__" data-feature="replace-image">
																<img src="images/showroom-detail-view-product.png" class="img-fluid" alt="showroom-detail-view-product">
															</div>
																...
																<div class="phantom-actions__dropdowns accordion active nd"
																	...
																	<div class="row margin-none">
																		<div class="col-2 feature-product__item-image a__simple">
																			...
																			>
																				<img src="images/lock_product-thumb.png" class="img-fluid selected-item-border" alt="">
																		...
																		<!-- <div class="col-2 feature-product__item-image drop_detail__items dropdown-two">
																			<div class="feature-detail__item-drop"
																				 title="Simple name"
																				 data-container="#collapseFeature-parent-2"
																			...
																			>
																				...
																				<button class="feature-detail__item-drop__show-more hover-btn__v2"
																						data-toggle="collapse"
																						data-target="#collapseFeature-12"
																						aria-expanded="true"
																						aria-controls="collapseFeature-12"
																				>
																				<svg xmlns="http://www.w3.org/2000/svg" width="3.726" height="6.536" viewBox="0 0 3.726 6.536"><defs><style>.a{fill:#fff;}</style></defs><g transform="translate(0 6.536) rotate(-90)"><path class="a" d="M3.268,3.726a.456.456,0,0,1-.324-.134L.134.781A.458.458,0,0,1,.781.134L3.268,2.621,5.755.134A.458.458,0,0,1,6.4.781L3.592,3.592A.456.456,0,0,1,3.268,3.726g></svg>
																				</button>
																		...
																		<!-- <div class="col-2 feature-product__item-image drop_detail__items dropdown-three">
																			<div class="feature-detail__item-drop"
																				 title="Simple name"
																				 data-container="#collapseFeature-parent-2"					
																			>
																				...
																				<button class="feature-detail__item-drop__show-more hover-btn__v2"
																						data-toggle="collapse"
																						data-target="#collapseFeature-13"
																						aria-expanded="true"
																						aria-controls="collapseFeature-13"
																				>
																				<svg xmlns="http://www.w3.org/2000/svg" width="3.726" height="6.536" viewBox="0 0 3.726 6.536"><defs><style>.a{fill:#fff;}</style></defs><g transform="translate(0 6.536) rotate(-90)"><path class="a" d="M3.268,3.726a.456.456,0,0,1-.324-.134L.134.781A.458.458,0,0,1,.781.134L3.268,2.621,5.755.134A.458.458,0,0,1,6.4.781L3.592,3.592A.456.456,0,0,1,3.268,3.726g></svg>
																				</button>
																		...
																		<div
																			id="collapseFeature-11" class="collapse show border-nd_hove_nd collapseFeature-opacity_class"
																	...
																	<div
																			id="collapseFeature-12" class="border-nd_hove_nd collapseFeature-opacity_class collapse show border-nd_hove_nd"
																			aria-labelledby="headingOne"
																			data-parent="#collapseFeature-parent-2"
																	>
																		<div class="row">
																	...
																	<div
																			id="collapseFeature-13" class="border-nd_hove_nd collapseFeature-opacity_class collapse show border-nd_hove_nd"
																			aria-labelledby="headingOne"
																			data-parent="#collapseFeature-parent-2"
																	>
																		<div class="row">
