...
<html lang="en">
	...
	<meta name="description" content="shopping-cart"><link href="./app.css" rel="stylesheet"></head>
						...
						<div class="row flex-lg-nowrap">
							...
							<div class="col col-auto__custom">
								<div class="card card-checkout card-checkout__header__main" id="shoppingCardTitle">
									<div class="card-body">
										<h5 class="card-checkout__header"><span
												class="card-checkout__header__main__back-icon">
											<a href="index.html" class="d-block"><img src="images/back-icon.svg" alt=""></a></span><span>Shopping Cart (3)</span>
										</h5>
										<!--SHOW THIS ON DESKTOP SCREEN-->
										<input class="checkbox__ch-card__checkbox selectable card-el__hide-on-md"
											   id="checkbox__select-all" type="checkbox" value="value1">
										<label for="checkbox__select-all"
											   class="checkbox__select-all__label card-el__hide-on-md">Select
											All</label>
										<!--#SHOW THIS ON DESKTOP SCREEN-->
									</div>
								</div>
