...
<html lang="en">
	...
	<meta name="description" content="product detail view"><link href="app.css" rel="stylesheet"></head>
	...
	<body class="clearfix product-detail product-detail__page">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12 col-lg-4 first-header__shipping">
							<a href="#" class="first-header__child">
								<img src="images/security.svg" alt=""/>
								100% Perfect fit guarantee
							</a>
							<a href="#" class="first-header__child">
								<img src="images/delivery-truck(2).svg" alt="" class="truck-image"/>
								free shipping
							</a>
						</div>
							...
							<div class="first-header__phone-card justify-content-center h-100">
								<div class="first-header__phone-card--phone">
									<div class="first-header__child">
										<a href="tel:1-888-312-7424" class="first-header__child__call" title="">
											<img src="images/call-answer.svg" alt="" class="phone-image"/>
											1-888-312-7424
										</a>
									</div>
								</div>
						...
						<div class="col-12 col-lg-4 desktop-show">
							<div class="first-header__phone-card pr-3">
								<div class="first-header__phone-card--phone">
									<div class="first-header__child">
										<div class="dropdown dropdown-about">
											<p class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown"
											   aria-haspopup="true" aria-expanded="false">Company</p>
											<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												<div class="dropdown-menu--content">
													<a class="dropdown-item" title="" href="#">About us</a>
													<a class="dropdown-item" title="" href="#">Services</a>
													<a class="dropdown-item" title="" href="#">Support</a>
													<a class="dropdown-item" title="" href="#">For the Pro's</a>
													<a class="dropdown-item" title="" href="#">Videos</a>
													<a class="dropdown-item" title="" href="#">Careers</a>
													<a class="dropdown-item" title="" href="#">Blog</a>
													<a class="dropdown-item" title="" href="#">Policies</a>
												</div>
											</div>
										</div>
									</div>
									<div class="first-header__child">
										<div class="dropdown dropdown-about js-account-wrap">
											<p class="dropdown-toggle account" id="dropdownAccountButton"
											...
											<div class="dropdown-menu account" aria-labelledby="dropdownAccountButton">
												<div class="dropdown-menu--content">
													<a class="dropdown-item account-menu-visible js-account-login"
													   title="" href="#">Login</a>
													<a class="dropdown-item account-menu-visible" title="" href="#">Register</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">Dashboard</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">Account
														settings</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">Start
														a new design</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">My
														orders</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">Payment
														settings</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">Idea
														folder</a>
													<a class="dropdown-item account-menu-hidden" title="" href="#">My
														designs</a>
													<a class="dropdown-item account-menu-hidden js-account-logout"
													   title="" href="#">Sign out</a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="first-header__phone-card--card">
									<!-- <a href="#" title="" class="first-header__child"></a> -->
									<div class="first-header__child wrap-save">
										<a href="#" title=""><img src="images/icon-save.svg" alt=""/></a>
										<div class="tooltip tooltip__save-images">
											<p class="text">Save favourite images under user account for future
												reference</p>
										</div>
									</div>
									<a href="" title="" data-toggle="checkout"
									   class="first-header__child toggleMenu first-header__open__dropdown-checkout"
									   id="toggleMenu">
										<img src="images/checkout.svg" alt="" class="shopping-bag js-add-to-card"/>
										<span class="badge badge-danger badge-round">3</span>
									</a>
								</div>
								<div class="dropdown-checkout  curtain curtain-menu hide" data-toggle="checkout"
									 id="curtain-menu">
									<div class="inner">
										<div class="list-wrap">
											<ul class="list">
																...
																<li class="list-item__options__list-option">
																	<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
																		<img class="img img-fluid"
																			 src="images/icon-close.svg" alt="">
																	</div>
																</li>
																<li class="list-item__options__list-option">
																	<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
																		<img class="img img-fluid"
																			 src="images/icon-save.svg" alt="">
																	</div>
																</li>
															</ul>
														</div>
														<a href="#" title="" class="media-link">
															<div class="media">
																<div class="wrap-img">
																	<img class="img-fluid img" src="images/team-1.png"
																		 alt="Generic placeholder image">
																</div>
																<div class="media-body">
																	<h5 class="item-title">Yaka pichka pod naem s mnogo
																		eftino obeshtawam</h5>
																	<div class="item-info">
																		<p class="item-qty">Qty: x12</p>
																		<p class="item-price">
																			<span class="item-price__text">Price:</span>
																			<span class="item-price__numbers">$44.44</span>
																		</p>
																	</div>
																</div>
															</div>
										...
										<div class="wrap-btn">
											<a href="shopping-cart.html" title="" class="btn btn-primary btn-cart">view
												cart</a>
										</div>
										<div class="inner">
											<p class="text-lg text-center">sub total: $543.34</p>
											<p class="wrap-btn">
												<a href="#" title="" class="btn btn-secondary btn-checkout btn-full">checkout</a>
											</p>
											<p class=" text-center ">
												<button class="btn-none text-small">Remove all product/s from cart
												</button>
											</p>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="mobile-show">
									<a href="#" title="">In response to the COVID-19 outbreak.</a>
								...
								<div class="desktop-show">
									<a href="#" title="">Learn about the necessary precautions we’re taking in response
										to the COVID-19 outbreak.</a>
									<button class="js-hide-covit">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
											 viewBox="0 0 24 24">
											<g transform="translate(0 -0.001)">
							...
							<div class="col-8 col-lg-9 second-header__logo-nav">
								...
								<nav class="second-header__logo-nav--navigation">
									<ul>
										...
										<li><a href="#" title="" class="active">Rooms</a></li>
										...
										<li>
											<div class="second-header__logo-nav--grop-down">
												<span>
													Process
													<img class="icon__plus" src="images/minus-button-1.svg" alt="">
													<img class="icon__minus" src="images/minus-button.svg" alt=""
														 style="display: none;">
												</span>
												<div class="dropdown-wrap">
													<div class="dropdown-content">
														<a href="#" title="">Fax a design</a>
														<a href="#" title="">Free in home consults</a>
														<a href="#" title="">We Design</a>
														<a href="#" title="">You Design</a>
													</div>
												</div>
											</div>
										</li>
										<li><a href="#" title="">Installation</a></li>
										<li><a href="#" title="">Specs</a></li>
							...
							<div class="col-4 col-lg-3 second-header__search">
								...
								<div class="mobile-show">
									<div class="first-header__phone-card--card">
										...
										<a href="tel:1-888-312-7424" title=""
										   class="first-header__child first-header__child__call">
											<img src="images/call-answer-mobile.svg" alt="" class="mobile-icon">
										</a>

										<button class="first-header__child js-show-user-nav"><img
												src="images/user-blue.svg" alt=""/></button>

										<a href="#" title="" data-toggle="checkout"
										   class="first-header__child toggleMenu first-header__open__dropdown-checkout"
										   id="toggleMenu">
											<img src="images/checkout-blue.svg" alt=""/>
											<span class="badge badge-danger badge-round">3</span>
										</a>
									</div>
									<div class="dropdown-checkout curtain curtain-menu hide" data-toggle="checkout"
										...
										<div class="inner">
														...
														<div class="item">
															...
															<a href="#" title="" class="media-link">
																<div class="media">
																	...
																	<div class="media-body">
																		<h5 class="item-title">Yaka pichka pod naem s
																			mnogo eftino obeshtawam</h5>
																		<div class="item-info">
																			<p class="item-qty">Qty: x12</p>
																			<p class="item-price">
																				<span class="item-price__text">Price:</span>
											...
											<div class="inner">
												...
												<p class="wrap-btn">
													<a href="#" title=""
													   class="btn btn-secondary btn-checkout btn-full">checkout</a>
												</p>
												<p class=" text-center ">
													<button class="btn-none text-small">Remove all product/s from cart
													</button>
										...
										<div class="account-block__navigation--wrapper">
											...
											<div class="account-block__navigation--user js-login-txt">
												<a href="#" title="" class="account-block__navigation--user-link">
													...
													<span class="account-block__navigation--user-plus">
														<svg xmlns="http://www.w3.org/2000/svg" width="42.5"
															 height="42.5" viewBox="0 0 42.5 42.5"><defs><style>.add-showroom {
                                                            fill: #02adb0;
                                                        }</style></defs><path class="add-showroom"
																			  d="M21.25,0A21.25,21.25,0,1,0,42.5,21.25,21.274,21.274,0,0,0,21.25,0Zm9.3,23.021H23.021v7.526a1.771,1.771,0,1,1-3.541,0V23.021H11.953a1.771,1.771,0,0,1,0-3.541h7.526V11.953a1.771,1.771,0,0,1,3.541,0v7.526h7.526a1.771,1.771,0,1,1,0,3.541Zm0,0"/></svg>
													</span>
												</a>
											...
											<nav class="account-block__navigation--navigation">
												<ul class="account-nav">
													...
													<li>
														<a href="#" title=""
														   class="account-nav__link account-mobile-menu-visible js-mobile-account-login">
															login
														</a>
													</li>
													<li>
														<a href="#" title=""
														   class="account-nav__link account-mobile-menu-visible">
															Register
														</a>
													</li>
													<li>
														<a href="account.html" title=""
														   class="account-nav__link account-menu-hidden">
													...
													<li>
														<a href="account-settings.html" title=""
														   class="account-nav__link account-menu-hidden">
													...
													<li>
														<a href="account-orders.html" title=""
														   class="account-nav__link account-menu-hidden svg-stroke">
															<svg xmlns="http://www.w3.org/2000/svg" width="21"
																 height="21.628" viewBox="0 0 21 21.628">
													...
													<li>
														<a href="account-payments.html" title=""
														   class="account-nav__link account-menu-hidden">
															<svg xmlns="http://www.w3.org/2000/svg" width="21.667"
																 height="17.755" viewBox="0 0 21.667 17.755">
																<defs>
																	<style>.wallet {
                                                                        fill: #384765;
                                                                    }</style>
													...
													<li class="mobile-show">
														<a href="account-idea-folder.html" title=""
														   class="account-nav__link account-menu-hidden">Idea folder</a>
													</li>
													<li class="mobile-show">
														<a href="#" title=""
														   class="account-nav__link account-menu-hidden">My designs</a>
													</li>
													<li>
														<a href="#" title=""
														   class="account-nav__link svg-stroke account-menu-hidden js-mobile-account-logout">
															<svg xmlns="http://www.w3.org/2000/svg" width="21.181"
																 height="23.04" viewBox="0 0 21.181 23.04">
		...
		<section class="home-mobile-buttons-block covid-block showroom-category-page product-detail">
			<div class="accordion accordion-organizer-landing-page showroom-details product-detail"
				 id="accordion-organizer-landing">
				<div class="card">
					<div class="d-flex align-items-center pl-2">
						<a href="#" class="d-flex align-items-center">
							<svg xmlns="http://www.w3.org/2000/svg" width="24.5" height="20.417"
								 viewBox="0 0 24.5 20.417">
								<defs>
									<style>.arrow-new {
                                        fill: #ffffff;;
                                    }</style>
								</defs>
								<path class="arrow-new"
									  d="M31.479,21.187H11.114l7.8-7.428A1.021,1.021,0,0,0,17.5,12.281L8.6,20.764a2.041,2.041,0,0,0,.018,2.9L17.5,32.135a1.021,1.021,0,1,0,1.408-1.478l-7.831-7.428h20.4a1.021,1.021,0,0,0,0-2.042Z"
									  transform="translate(-8 -12)"/>
							</svg>
						</a>
						<div class="card-header" id="headingOne">
							<h2 class="mb-0">
								<button class="accordion-organizer-button js-filter-fix-body" type="button"
					...
					<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
						 data-parent="#accordion-organizer-landing">
						<div class="card-body">
							<div class="bootstrap-select__ctg__wrap organizer-filters-block__wrapper js-filters-box">

								<form class="w-100 text-center">
									<div class="bootstrap-select__ctg">
										<select
												class="select-stg multiselectbox selectpicker"
												multiple
												title="Color"
										>
											<option class="my-custom-option">Black</option>
											<option class="my-custom-option">Gray</option>
											<option class="my-custom-option">Green</option>
											<option class="my-custom-option">Blue</option>
											<option class="my-custom-option">Red</option>
										</select>
									</div>
									<div class="bootstrap-select__ctg">
										<select
												...
												title="Shape"
										>
											<option class="my-custom-option">Elipse</option>
											<option class="my-custom-option">Gray</option>
											<option class="my-custom-option">Green</option>
											<option class="my-custom-option">Blue</option>
											<option class="my-custom-option">Red</option>
									...
									<div class="bootstrap-select__ctg">
										<select
												...
												title="Size"
										>
											<option class="my-custom-option">XXL</option>
											<option class="my-custom-option">XL</option>
											<option class="my-custom-option">L</option>
											<option class="my-custom-option">M</option>
											<option class="my-custom-option">S</option>
										</select>
									</div>
									<div class="bootstrap-select__ctg">
										<select
												...
												title="Fabric"
										>
											<option class="my-custom-option">Cotton</option>
											<option class="my-custom-option">XL</option>
											<option class="my-custom-option">Red</option>
											<option class="my-custom-option">Gray123</option>
											<option class="my-custom-option">S</option>
										</select>
									</div>
									...
									<div class="bootstrap-select__ctg">
										<select
												...
												title="Specification"
										>
											<option class="my-custom-option">80*60*40cm</option>
											<option class="my-custom-option">60*40*30cm</option>
											<option class="my-custom-option">50*40*30cm</option>
											<option class="my-custom-option">40*40*25cm</option>
											<option class="my-custom-option">33*15*85cm</option>
										</select>
									</div>

									<!-- <div class="form-group accordion-organizer-form-group">
										<label for="specification" class="sr-only">Specification</label>
										<input type="text" name="specification" class="form-control accordion-organizer-form-input" placeholder="Specification">
									</div> -->
									<div class="d-flex justify-content-between">
										<button type="button" class="btn btn-secondary accordion-organizer-submit">Apply
											filters
										</button>
										<button type="button"
												class="btn btn-secondary accordion-organizer-submit js-clear-filter">
											Clear filters
										</button>
									</div>
								</form>
		...
		<main class="main clearfix">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="#">Master closet Organizers</a></li>
									...
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												...
												<h2 class="simple-block__heading--heading text-center">Murphy Bed Design
													Ideas</h2>
						...
						<div class="row">
							<div class="col-12 desktop-show ">
								<div class="simple-block__filters simple-block__filters__centered js-product-filters">
									...
									<button class="simple-block__filter--button js-clear-all-product-filters">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
											 viewBox="0 0 24 24">
											<g transform="translate(0 -0.001)">
												<g transform="translate(0 0.001)">
									...
									<div class="simple-block__filter--product-id">
										<p>Product Id: 000114 / SKU #: 4200 / Brand: Sidelines</p>
									</div>
								</div>
							</div>
									...
									<div class="row">
										<div class="col-12">
											<div class="product-detail__carousel image-gallery js-add-to-card-image-holder">
												<a href="https://www.youtube.com/embed/Wb0JINqX71w"
												   data-poster="images/yt-placeholder.png">
													<img src="images/yt-placeholder.png" alt="" class="img-fluid"/>
												</a>
									...
									<div class="row">
										<div class="col-12">
											<div class="product-detail__carousel-nav">
												<div>
													<img src="images/yt-placeholder.png" alt=""
									...
									<div class="row">
										<div class="col-12">
											<div class="back-to-filters-wrap">
												<a href="#" title="" class="btn btn-primary pt-2 pb-2  ">
													back to filters
												</a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-12">
													<div class="row">
														...
														<div class="col-12 mobile-show">
															<p class="product-purchase__quantity-description">Additional
																5% off (3 pieces or more)</p>
														</div>
														<div class="col-12 col-lg-6">
															<div class="row">
																<div class="col-12">
																	<div class="product-purchase__buy-add-to-card-wrap">
																		<button class="btn btn-secondary product-purchase__buy-now">
																			Buy now
																		</button>
																		<button class="btn btn-primary product-purchase__add-to-card js-add-to-card-button">
																			Add to cart
																		</button>
																	</div>
																</div>
												...
												<ul class="nav nav-pills product-nav" id="pills-tab" role="tablist">
													...
													<li class="nav-item">
														<a class="nav-link product-nav__link"
														   ...
														   aria-controls="pills-Installations" aria-selected="false">Installations</a>
													</li>
												</ul>
										...
										<div class="tab-content product-tab-content" id="pills-tabContent" data-target="pills-tabContent">
											<div class="tab-pane fade show active" id="pills-description"
												...
												<div class="tab-content__text-wrap js-text-wrap">
													<p class="tab-content__text-wrap--title">
														Closet organizers skillfully crafted with superior quality
														materials at affordable prices. Guaranteed easy install and
														ships free.
													</p>

													<div class="tab-content__text-wrap--content js-hidden-text small-text">
														<p class="tab-content__text-wrap--text">
															Closet organizers are the ultimate do it yourself project.
															They not only make your life simpler, they also bring about
															a lifetime of satisfaction. The Closets To Go closet
															organizers are the easiest to design and assemble. From our
															easy-to-adjust hanging bracket to the pre-assembly of all
															your hardware fittings and labeled panels, we've virtually
															made reading instructions a thing of the past. Our custom
															closet organizers are the easiest to install in the nation,
															guaranteed! They're also constructed with high-quality,
															environmentally-friendly materials made right here in the
															United States. Carefully constructed exactly to your
															specifications, our closet organizers can solve a number of
															organizational issues, whether it be more space for kitchen
															storage, a new place in your garage to store seasonal items
															and tools or a room to showcase your exquisite fashion
															taste. It's easy to get started - simply click "Start
															Designing" below to request a complimentary closet design or
															try your hand at our easy-to-use online closet design
															software. Whatever it is you're looking for, our custom
															closet organizers will satisfy all your space saving and
															organizational needs. Experience the Closets To Go
															difference and see why nationwide customers are repeat
															customers!
														</p>
													</div>
												</div>

												<button data-readall="Read all" data-readless="Read less"
											...
											<div class="tab-pane fade" id="pills-specifications" role="tabpanel"
												...
												<div class="tab-content__specifications">
													<p class="tab-content__specifications--heading">Drawer
														Specifications</p>
													...
													<div class="row">
														<div class="col-12 mobile-text-center">
															<a href="#" class="link-button mt-4 mb-0 margin_nd__a">
																download pdf
													...
													<div class="row row-padding__a-v2">
														<div class="col-12 js-specifications-subheading_v2">
															<p class="tab-content__specifications--subheading">
																Description
																<img class="tab-content__specifications--subheading-icon-plus"
																	 src="images/minus-button-1.svg" alt="">
																<img class="tab-content__specifications--subheading-icon-minus"
																	 src="images/minus-button.svg" alt="">
															</p>
														</div>
														<div class="col-12 padding-no__a-v2">
															<div class="row row-with-desctop-border-bottom">
																<div class="col-12">
																	<div class="tab-content__specifications--images-block">
																...
																<div class="col-12">
																	...
																	<div class="tab-content__specifications--description-wrap"
																		 id="materials">
																		<p class="first-footer__heading mb-3">
																			Materials</p>
																	</div>
																	<div class="tab-content__specifications--description-wrap"
																		 id="useful-tips">
																		<p class="first-footer__heading mb-3">usefull
																			tips</p>
																	</div>
																	<div class="tab-content__specifications--description-wrap"
																		 id="useful-links">
																		<p class="first-footer__heading mb-3">useful
																			links</p>
																	</div>
																</div>
															</div>
											...
											<div class="tab-pane fade" id="pills-reviews" role="tabpanel"
												...
												<div>
													...
													<p class="mobile-text-center mt-2 mb-0">
														<a href="#" title="" class="product-tab-content__link">See
															more</a>
													</p>
												</div>
											</div>
											<div class="tab-pane fade" id="pills-Installations" role="tabpanel"
												...
												<div class="product-dyi-installer mt-2">
														...
														<div class="col-12">
															<div class="embed-responsive embed-responsive-16by9 mb-4">
																<iframe class="embed-responsive-item" width="100%"
																		height="auto"
																		src="https://www.youtube.com/embed/Wb0JINqX71w"
													...
													<div class="row">
														<div class="col-12">
															<div class="row">
																<div class="col-12 col-lg-6">
																	<p class="product-dyi-installer__heading">DIY
																		installer</p>
																</div>
																<div class="col-12 col-lg-6">
																	<div class="product-dyi-installer__heading-button-wrap">
																		<button class="product-dyi-installer__heading-button product-detail">
																			<span class="desktop-text">Instructions</span>
																			<svg xmlns="http://www.w3.org/2000/svg"
																				 width="28.704" height="23.92"
																				 viewBox="0 0 28.704 23.92">
																				<g id="direct-download"
																				   transform="translate(0 -2)">
																					<path id="Path_441"
																						  data-name="Path 441"
																						  d="M13.176,18.744a.9.9,0,0,1-.648-.277L6.249,11.889A.9.9,0,0,1,6.9,10.372h3.289V3.5a1.5,1.5,0,0,1,1.5-1.5h2.99a1.5,1.5,0,0,1,1.5,1.5v6.877h3.289a.9.9,0,0,1,.648,1.517l-6.279,6.578A.9.9,0,0,1,13.176,18.744Z"
																						  transform="translate(1.176)"
																						  fill="#db440d"></path>
																					<path id="Path_442"
																						  data-name="Path 442"
																						  d="M26.611,22.784H2.093A2.1,2.1,0,0,1,0,20.691v-.6A2.1,2.1,0,0,1,2.093,18H26.611A2.1,2.1,0,0,1,28.7,20.093v.6A2.1,2.1,0,0,1,26.611,22.784Z"
																						  transform="translate(0 3.136)"
																						  fill="#db440d"></path>
																				</g>
																			</svg>
																			<span class="mobile-text">Download Instructions</span>
																		</button>
																	</div>
																</div>
															</div>
																	...
																	<div class="row">
																		<div class="col-12">
																			<p class="product-dyi-installer__text need-hours">
																				<svg xmlns="http://www.w3.org/2000/svg"
																					 width="23.797" height="22"
																					 viewBox="0 0 23.797 22">
																						   ...
																						   transform="translate(0 1.775)">
																							<g id="Group_335"
																							   data-name="Group 335">
																								<path id="Path_182"
																									  data-name="Path 182"
																									  d="M23.75,11.063a.5.5,0,0,0-.454-.288H21.814a10.992,10.992,0,1,0-1.287,7.5,1,1,0,0,0-1.731-1,9.009,9.009,0,1,1,.972-6.5H18.3a.5.5,0,0,0-.385.82l2.5,3a.5.5,0,0,0,.768,0l2.5-3A.5.5,0,0,0,23.75,11.063Z"
																									  transform="translate(0 -1.775)"
																									  fill="#edb700"></path>
																								<path id="Path_183"
																									  data-name="Path 183"
																									  d="M20.02,6.713a1,1,0,0,0-1,1v6.068a1.748,1.748,0,0,0,1,3.183,1.728,1.728,0,0,0,.738-.169L24.237,18.8a.989.989,0,0,0,.5.135,1,1,0,0,0,.5-1.866l-3.482-2.011a1.742,1.742,0,0,0-.734-1.279V7.713A1,1,0,0,0,20.02,6.713Zm0,9.25a.75.75,0,1,1,.75-.749A.751.751,0,0,1,20.02,15.963Z"
																									  transform="translate(-9.02 -4.213)"
																									  fill="#edb700"></path>
																							</g>
																						</g>
																					</g>
																				</svg>
																				Just 4-6 hours to install a 10 x 10
																				closet.
																			</p>
																		</div>
																		<div class="col-12">
																			<p class="product-dyi-installer__text perfect-fit">
																				<svg id="security"
																					 xmlns="http://www.w3.org/2000/svg"
																					 width="15.756" height="18.752"
																					 viewBox="0 0 15.756 18.752">
																					<path fill="#384765" id="Path_21"
																						  data-name="Path 21"
																						  d="M32.848,4.829c-.01-.506-.019-.985-.019-1.447a.656.656,0,0,0-.656-.656A9.05,9.05,0,0,1,25.447.186a.656.656,0,0,0-.915,0,9.048,9.048,0,0,1-6.725,2.539.656.656,0,0,0-.656.656c0,.463-.009.941-.019,1.448-.09,4.711-.213,11.164,7.643,13.887a.656.656,0,0,0,.43,0C33.061,15.993,32.938,9.54,32.848,4.829ZM24.99,17.4c-6.737-2.447-6.636-7.809-6.545-12.545.005-.284.011-.56.014-.83A10.121,10.121,0,0,0,24.99,1.549a10.123,10.123,0,0,0,6.531,2.475c0,.27.009.545.014.829C31.626,9.59,31.728,14.951,24.99,17.4Z"
																						  transform="translate(-17.112 0)"></path>
																					<path fill="#384765" id="Path_22"
																						  data-name="Path 22"
																						  d="M74.149,79.078l-3.168,3.168L69.63,80.894a.656.656,0,0,0-.928.928l1.816,1.816a.656.656,0,0,0,.928,0l3.632-3.632a.656.656,0,0,0-.928-.928Z"
																						  transform="translate(-64.011 -71.982)"></path>
																				</svg>
																				100% Perfect Fit Guarantee
																			</p>
																		</div>
																		...
																		<div class="col-12">
																			<div class="product-dyi-installer__small-images-boxes">
																				<div class="d-flex">
																					<div class="product-dyi-installer__small-images-box yellow">
																						<svg xmlns="http://www.w3.org/2000/svg"
																							 width="26.77"
																							 height="25.914"
																							 viewBox="0 0 26.77 25.914">
																							<g id="screwdriver-and-wrench"
																							   transform="translate(0 -0.428)">
																								<path id="Path_436"
																									  data-name="Path 436"
																									  d="M17.6,12.3a2.781,2.781,0,0,1,1.854-.457l7.314-7.316-4.1-4.1L15.358,7.744a2.762,2.762,0,0,1-.476,1.877Z"
																									  fill="#c2c2c2"></path>
																								<path id="Path_437"
																									  data-name="Path 437"
																									  d="M4.842,21.207l-.265-.265L3.19,22.063.854,25.744l.6.6,3.684-2.336,1.12-1.383-.266-.269L10.642,17.7l-1.156-1.14Z"
																									  fill="#c2c2c2"></path>
																								<path id="Path_438"
																									  data-name="Path 438"
																									  d="M11.2,8.307A5.7,5.7,0,0,0,4.215,1.262L7.448,4.494,6.6,7.66l-3.17.848L.2,5.278A5.709,5.709,0,0,0,7.486,12.2l.018.018,13.3,13.3A2.695,2.695,0,0,0,24.614,21.7ZM22.94,25.061a1.029,1.029,0,1,1,1.031-1.029A1.027,1.027,0,0,1,22.94,25.061Z"
																									  fill="#c2c2c2"></path>
																							</g>
																						</svg>
																					</div>
																				...
																				<p class="product-dyi-installer__text">
																					Middle degree of difficulty</p>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-12">
																			<p class="product-dyi-installer__heading mobile-bold">
																				Tools required to complete the
																				installation</p>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-12">
																			<div class="product-dyi-installer__big-images-boxes">
																				<div class="product-dyi-installer__big-images-box multimeter">
																					<svg xmlns="http://www.w3.org/2000/svg"
																						 width="35.984" height="63.665"
																						 viewBox="0 0 35.984 63.665">
																						<g id="multimeter"
																						   transform="translate(-111.309)">
																							<path id="Path_455"
																								  data-name="Path 455"
												...
												<div class="product-dyi-installer second-dyi-installer mt-2">
													<div class="row">
														<div class="col-12">
															<p class="product-dyi-installer__heading">Professional
																installer</p>
														</div>
													</div>
													<div class="row">
														<div class="col-12">
															<div class="row row-with-mobile-border-bottom">
																<div class="col-12 mb-3">
																	<p class="d-block product-dyi-installer__text mobile-blue">
																		Choose which option makes the most sense when
																		considering our DIY solution, <span
																			class="special-text">hire a professional</span>
																		or do it themselves.</p>
																</div>
															</div>
															<div class="row">
																<div class="col-12">
															...
															<div class="row">
																<div class="col-12">
																	<div class="product-dyi-installer__small-images-boxes">
																		...
																		<p class="product-dyi-installer__text">Easiest
												...
												<p class="mobile-text-center mt-2 mb-0">
													<a href="#" title="" class="product-tab-content__link">Read more</a>
												</p>
											</div>
										</div>
									</div>
			...
			<!--Related products -> 5 BOX COL-->
			<section class="five-elements-block product-detail">
				<div class="wrapper">
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								...
								<div class="row mt-4">
									<div class="col-12 five-elements-block__content">
										<div class="five-elements-block__wrapper services-caro">
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#">
													<figure>
											...
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#">
													<figure>
														...
														<figcaption>
															<p>Custom Closets: Order Online Today</p>
														</figcaption>
													</figure>
												</a>
											</div>
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#">
													<figure>
														...
														<figcaption>
															<p>Closet Design: Easy Online Design Tool</p>
														</figcaption>
													</figure>
												</a>
											</div>
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#">
													<figure>
														<div class="five-elements-block__wrapper--image">
															<img src="images/solution-4.png" alt="">
														</div>
														<figcaption>
															<p>Closet Systems: Designed By You, Crafted By Us</p>
														</figcaption>
													</figure>
												</a>
											</div>
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#">
													<figure>
														<div class="five-elements-block__wrapper--image">
															<img src="images/solution-5.png" alt="">
														</div>
														<figcaption>
															<p>Closet Organizers: Custom-designed by you,
																quality-b...</p>
														</figcaption>
													</figure>
												</a>
			...
			<!--RELATED CATEGORIES 4 BOX COL-->
			<section class="catalog-block product-detail">
				<div class="wrapper">
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								<div class="row services-caro">
									...
									<div class="row showroom-detail-product-row">
										<div class="col-12 col-xl-7 showroom-detail-product-col-lg">
											<div class="you-design-block__image">
												<img src="images/you-design-product.png" alt="" class="img-fluid">
											</div>
										</div>
										<div class="col-12 col-xl-5 showroom-detail-product-col-lg">
											<div class="you-design-block__wrapper">
												...
												<h2 class="you-design-block__wrapper--heading">You design</h2>
												<p class="you-design-block__wrapper--text small-text">Lorem ipsum dolor
													sit amet, consetetur
													sadipscing elitr, sed diam nonumy eir...</p>
												<div class="you-design-block__wrapper--text-group">
													<div>
														<img src="images/Group174.svg" alt="" class="img-fluid">
														<p>10k 214</p>
													</div>
							...
							<div class="col-12 col-lg-6">
								<div class="you-design-block we-desing-block product-detail">
									<div class="row showroom-detail-product-row">
										<div class="col-12 col-xl-7 showroom-detail-product-col-lg">
											<div class="you-design-block__image">
												<img src="images/we-design-product.png" alt="" class="img-fluid">
											</div>
										</div>
										<div class="col-12 col-xl-5 showroom-detail-product-col-lg">
											<div class="you-design-block__wrapper">
		...
		<div class="mobile-show">
			<div class="mobile-footer-buttons">
				...
				<a href="#" title="" class="mobile-footer-buttons__second"><img src="images/icon-save.svg" alt=""
																				class="img-fluid"></a>
