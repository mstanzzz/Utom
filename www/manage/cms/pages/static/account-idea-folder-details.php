...
<html lang="en">
	...
	<meta name="description" content="Account idea folder details"><link href="app.css" rel="stylesheet"></head>
	<body>
								...
								<div class="first-header__phone-card pr-3">
											...
											<div class="dropdown dropdown-about js-account-wrap">
												...
												<div class="dropdown-menu account" aria-labelledby="dropdownAccountButton">
													<div class="dropdown-menu--content">
														...
														<a class="dropdown-item account-menu-hidden" title="" href="#">Account settings</a>
														<a class="dropdown-item account-menu-hidden" title="" href="#">Start a new design</a>
														<a class="dropdown-item account-menu-hidden" title="" href="#">My orders</a>
														<a class="dropdown-item account-menu-hidden" title="" href="#">Payment settings</a>
														<a class="dropdown-item account-menu-hidden" title="" href="#">Idea folder</a>
														<a class="dropdown-item account-menu-hidden" title="" href="#">My designs</a>
														<a class="dropdown-item account-menu-hidden js-account-logout" title="" href="#">Sign out</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="first-header__phone-card--card">
										...
										<div class="first-header__child wrap-save">
											...
											<div class="tooltip tooltip__save-images">
												<p class="text">Save favourite images under user account for future reference</p>
											</div>
										</div>
										<a href="" title="" data-toggle="checkout"	class="first-header__child toggleMenu first-header__open__dropdown-checkout" id="toggleMenu">
									...
									<div class="dropdown-checkout  curtain curtain-menu hide" data-toggle="checkout" id="curtain-menu">
										<div class="inner">
													...
													<li class="list-item">
														<div class="item">
																...
																<ul class="list-item__options__list">
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
																			<img class="img img-fluid" src="images/icon-close.svg" alt="">
																		</div>
																	</li>
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
																			<img class="img img-fluid" src="images/icon-save.svg" alt="">
																		</div>
																	</li>
																</ul>
															</div>
															<a href="#" title="" class="media-link">
																<div class="media">
																	<div class="wrap-img">
																		<img class="img-fluid img" src="images/team-1.png" alt="Generic placeholder image">
																	</div>
																	<div class="media-body">
																		<h5 class="item-title">Yaka pichka pod naem s mnogo eftino obeshtawam</h5>
																		<div class="item-info">
											...
											<div class="wrap-btn">
												<a href="shopping-cart.php" title="" class="btn btn-primary btn-cart">view cart</a>
											</div>
											<div class="inner">
												...
												<p class=" text-center ">
													<button class="btn-none text-small">Remove all product/s from cart</button>
												</p>
											</div>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="desktop-show">
									<a href="#" title="">Learn about the necessary precautions we’re taking in response to the	COVID-19 outbreak.</a>
									<button class="js-hide-covit">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g transform="translate(0 -0.001)"><g transform="translate(0 0.001)"><path d="M13.326,12l10.4-10.4A.938.938,0,0,0,22.4.275L12,10.675,1.6.275A.938.938,0,0,0,.274,1.6L10.674,12,.274,22.4A.938.938,0,0,0,1.6,23.726L12,13.327l10.4,10.4A.938.938,0,0,0,23.725,22.4Z" transform="translate(0 -0.001)"/></g></g></svg>
									</button>
								</div>
										...
										<li>
											<div class="second-header__logo-nav--grop-down">
												<span>
													...
													<img class="icon__minus" src="images/minus-button.svg" alt="" style="display: none;">
												</span>
							...
							<div class="col-4 col-lg-3 second-header__search">
								...
								<div class="mobile-show">
									<div class="first-header__phone-card--card">
										...
										<button class="first-header__child js-show-user-nav"><img src="images/user-blue.svg" alt=""/></button>
										...
										<div class="account-block__navigation--wrapper">
											...
											<nav class="account-block__navigation--navigation">
												<ul class="account-nav">
													...
													<li>
														<a href="account.php" title="" class="account-nav__link account-menu-hidden">
													...
													<li>
														<a href="account-settings.php" title="" class="account-nav__link account-menu-hidden">
													...
													<li>
														<a href="account-orders.php" title="" class="account-nav__link account-menu-hidden svg-stroke">
													...
													<li>
														<a href="account-payments.php" title="" class="account-nav__link account-menu-hidden">
													...
													<li class="mobile-show">
														<a href="account-idea-folder.php" title="" class="account-nav__link account-menu-hidden">Idea folder</a>
													</li>
													<li class="mobile-show">
						...
						<div class="col-12">
							<div class="home-mobile-buttons-block__wrapper">
								...
								<div class="account-nav__content">
									<a href="account.php" title="" class="home-mobile-buttons-block__link account-small-link">Dashboard</a>
									<a href="account-settings.php" title="" class="home-mobile-buttons-block__link account-big-link">Account settings</a>
									<a href="#" title="" class="home-mobile-buttons-block__link account-big-link">Start a new design</a>
									<a href="account-orders.php" title="" class="home-mobile-buttons-block__link account-small-link">My orders</a>
									<a href="account-payments.php" title="" class="home-mobile-buttons-block__link account-big-link">Payment settings</a>
								</div>
		...
		<section class="mobile-order-search covid-block mobile-idea-folder mobile-idea-folder--details js-mobile-idea-folder-header">
			<div class="mobile-idea-folder__buttons">
				<a href="account-idea-folder.php" class="mobile-idea-folder__button full-with-button js-back-house-list">
				...
				<button class="mobile-idea-folder__button manage-folders" data-toggle="modal" data-target="#manageHouses">
					...
					<span>Manage folder/s</span>
				</button>
			</div>
			<div class="mobile-idea-folder--details__wparpper">
				<button class="mobile-idea-folder--details__button js-hide-folder-nav-content-btn">
					<svg xmlns="http://www.w3.org/2000/svg" width="24.5" height="20.417" viewBox="0 0 24.5 20.417"><defs><style>.arrow-new{fill:#384765;}</style></defs><path class="arrow-new" d="M31.479,21.187H11.114l7.8-7.428A1.021,1.021,0,0,0,17.5,12.281L8.6,20.764a2.041,2.041,0,0,0,.018,2.9L17.5,32.135a1.021,1.021,0,1,0,1.408-1.478l-7.831-7.428h20.4a1.021,1.021,0,0,0,0-2.042Z" transform="translate(-8 -12)"/></svg>
				</button>

				<div class="mobile-idea-folder--details__content">
					<h2 class="mobile-idea-folder--details__heading">Title house name 1</h2>
					<span class="mobile-idea-folder--details__text-box">
						Bedroom <span>105 items</span>
					</span>
				</div>

				<button class="account-mobile-more-info-btn idea-folder-details js-show-mobile-action-btn">
				</button>
				...
				<div class="account-mobile-more-info-wrapper js-show-mobile-action-buttons">
					<div class="account-mobile-more-info-wrapper__mobile-more-info">
						<button class="">Reorder by</button>
						<button class="">Specification sheet</button>
						<button class="">Share room</button>
								...
								<div class="account-block__navigation--wrapper">
									...
									<nav class="account-block__navigation--navigation">
										<ul class="account-nav">
											...
											<li class="mobile-show">
												<a href="account-idea-folder.php" title="" class="account-nav__link active account-menu-hidden">Idea folder</a>
											</li>
											<li class="mobile-show">
												<a href="#" title="" class="account-nav__link account-menu-hidden">My designs</a>
											</li>
											...
											<div class="d-flex flex-column justify-content-center w-100 h-100">
												...
												<div class="d-flex">
													...
													<div class="account-block__general-info--details d-flex flex-column justify-content-center align-items-start w-100">
														<div class="row w-100">
															<div class="col-12"><p class="first-text">Title house name 1</p></div>
														</div>
														<div class="row w-100">
															<div class="col-7"><p class="second-text">Created room/s:</p></div>
															<div class="col-5"><p class="second-text">16</p></div>
														</div>
														<div class="row w-100">
															<div class="col-7"><p class="second-text">Saved item/s:</p></div>
															<div class="col-5"><p class="second-text">15</p></div>
														</div>
													</div>
												</div>

												<div class="account-block__buttons-block idea-folder mt-4 mb-0">
													<a href="account-idea-folder.php" class="account-block__buttons-block--button js-back-house-list">
													...
													<button class="account-block__buttons-block--button manage-folders" data-toggle="modal" data-target="#manageHouses">
														<span class="button-image">
															<svg xmlns="http://www.w3.org/2000/svg" width="21.667" height="17.755" viewBox="0 0 21.667 17.755"><defs><style>.wallet{fill:#384765;}</style></defs><g transform="translate(0 -39)"><g transform="translate(0 39)"><g transform="translate(0 0)"><path class="wallet" d="M19.591,39H4.429a2.081,2.081,0,0,0-2.071,2.081v.025H2.076A2.075,2.075,0,0,0,0,43.173v11.5a2.088,2.088,0,0,0,2.076,2.081H17.238a2.081,2.081,0,0,0,2.071-2.081v-.025h.281a2.075,2.075,0,0,0,2.076-2.066v-11.5A2.085,2.085,0,0,0,19.591,39ZM17.238,55.752H2.076A1.085,1.085,0,0,1,1,54.673v-11.5A1.072,1.072,0,0,1,2.076,42.11H17.238a1.065,1.065,0,0,1,1.068,1.063v2.869a1.235,1.235,0,0,1-.266.03H15.147a2.856,2.856,0,0,0,0,5.713h2.889c.09-.005.181-.015.266-.025l.005,2.914A1.078,1.078,0,0,1,17.238,55.752Zm3.426-3.17a1.072,1.072,0,0,1-1.073,1.063H19.31V51.4a2.741,2.741,0,0,0,.577-.527l.777-1Zm-1.57-2.317a1.35,1.35,0,0,1-1.053.522H15.147a1.856,1.856,0,0,1,0-3.711h2.889a2.288,2.288,0,0,0,1-.226,2.332,2.332,0,0,0,.848-.682l.777-1,.005,3.064Zm1.57-6.741L19.31,45.269v-2.1a2.068,2.068,0,0,0-2.071-2.066H3.36v-.025A1.078,1.078,0,0,1,4.429,40H19.591a1.085,1.085,0,0,1,1.073,1.078v2.443Z" transform="translate(0 -39)"></path></g></g><g transform="translate(14.565 48.429)"><path class="wallet" d="M292.105,227h-1.2a.5.5,0,1,0,0,1h1.2a.5.5,0,0,0,0-1Z" transform="translate(-290.4 -227)"></path></g></g></svg>
														</span>
														<span class="button-text">
															Manage folder/s<br />
															<span>add/remove, rename folder/s</span>
														</span>
													</button>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-12 col-lg-3 js-folder-nav-wrap">
											<div class="nav flex-column nav-pills folder-nav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
												<a class="nav-link folder-nav__link js-hide-folder-nav js-desktop-active" id="v-pills-global-tab" data-toggle="pill" href="#v-pills-global" role="tab" aria-controls="v-pills-global" aria-selected="false">Global <span>5 <span>items</span></span></a>
												<a class="nav-link folder-nav__link js-hide-folder-nav" id="v-pills-living-room-tab" data-toggle="pill" href="#v-pills-living-room" role="tab" aria-controls="v-pills-living-room" aria-selected="false">Living Room <span>5 <span>items</span></span></a>
												...
												<div class="tab-pane fade" id="v-pills-global" role="tabpanel" aria-labelledby="v-pills-global-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<h3 class="folder-wrapper__heading">Title house name 1 - Global</h3>
																</div>
																<div class="col-4">
														...
														<div class="row">
																...
																<div class="folder-wrapper__saved-elements">
																	<figure class="folder-wrapper__saved-element specification-sheet">
																		<figcaption class="folder-wrapper__saved-element--folders">
																			...
																			<button class="folder-wrapper__saved-element--folders-button">open folder</button>
																		</figcaption>
																	</figure>
																	...
																	<figure class="folder-wrapper__saved-element">
																		<img src="images/idea-folder-room-3.png" alt="" class="folder-wrapper__saved-element--img img-fluid">
																	...
																	<figure class="folder-wrapper__saved-element">
																		<img src="images/idea-folder-room-4.png" alt="" class="folder-wrapper__saved-element--img img-fluid">
																		<figcaption class="folder-wrapper__saved-element--text-box">
																			<a href="#" title="" class="folder-wrapper__saved-element--link"></a>
																			<div class="folder-wrapper__saved-element--buttons">
																				<button class="shere">
																	...
																	<figure class="folder-wrapper__saved-element">
																		<img src="images/idea-folder-room-5.png" alt="" class="folder-wrapper__saved-element--img img-fluid">
																		<figcaption class="folder-wrapper__saved-element--text-box">
																			<a href="#" title="" class="folder-wrapper__saved-element--link"></a>
																			<div class="folder-wrapper__saved-element--buttons">
																				<button class="shere">
																	...
																	<figure class="folder-wrapper__saved-element">
																		<img src="images/idea-folder-room-2.png" alt="" class="folder-wrapper__saved-element--img img-fluid">
																		<figcaption class="folder-wrapper__saved-element--text-box">
																			<a href="#" title="" class="folder-wrapper__saved-element--link"></a>
																			<div class="folder-wrapper__saved-element--buttons">
																				<button class="shere">
																	...
																	<div class="folder-wrapper__specification-sheet--wrapper-content">
																		...
																		<div class="folder-wrapper__specification-sheet--wrapper-image-wrap">
																			<figure class="folder-wrapper__specification-sheet--wrapper-image-box">
																				<img src="images/idea-folder-room-5.png" alt="" class="folder-wrapper__specification-sheet--wrapper-image-img img-fluid">
																			...
																			<figure class="folder-wrapper__specification-sheet--wrapper-image-box">
																				<img src="images/idea-folder-room-2.png" alt="" class="folder-wrapper__specification-sheet--wrapper-image-img img-fluid">
																			...
																			<figure class="folder-wrapper__specification-sheet--wrapper-image-box">
																				<img src="images/idea-folder-room-3.png" alt="" class="folder-wrapper__specification-sheet--wrapper-image-img img-fluid">
																		...
																		<div class="folder-wrapper__specification-sheet--wrapper-image-wrap">
																			...
																			<figure class="folder-wrapper__specification-sheet--wrapper-image-box">
																				<img src="images/idea-folder-room-4.png" alt="" class="folder-wrapper__specification-sheet--wrapper-image-img img-fluid">
															...
															<div class="col-12 js-add-to-rooms-new-idea-folder-images" style="display: none;">
																<div class="new-idea-folder-images__wrapper">
																	...
																	<div class="folder-wrapper__saved-elements">
																		<figure class="folder-wrapper__saved-element add-new-button js-url-modal-btn" data-tab-parrent="#v-pills-global" data-button-positon="folder-name" data-toggle="modal" data-target="#newImageUrl">
																			<figcaption class="add-new-button__wrap">
							...
							<div class="first-footer__wrapper">
								<nav class="first-footer__wrapper--border js-show-all-footer-menu">
									...
									<ul class="first-footer__navivation">
										...
										<li class="hidden-footer-menu-item"><a href="#" title="Wall Beds">Wall Beds</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Craft Storage Systems">Craft Storage Systems</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Wall Beds">Wall Beds</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Craft Storage Systems">Craft Storage Systems</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Wall Beds">Wall Beds</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Craft Storage Systems">Craft Storage Systems</a></li>
							...
							<div class="first-footer__wrapper">
								<nav class="first-footer__wrapper--border js-show-all-footer-menu">
									...
									<ul class="first-footer__navivation">
										...
										<li><a href="#" title="About Closets To Go">About Closets To Go</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Shipping">Shipping</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Closet Order Process">Closet Order Process</a></li>
										<li class="hidden-footer-menu-item"><a href="#" title="Closet Purchase Policy">Closet Purchase Policy</a></li>
										<li><button class="first-footer__nav-show-button js-show-all-footer-menu-btn">See more...</button></li>
									</ul>
									<button class="first-footer__nav-hide-button js-hide-all-footer-menu-btn">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g transform="translate(0 -0.001)"><g transform="translate(0 0.001)"><path d="M13.326,12l10.4-10.4A.938.938,0,0,0,22.4.275L12,10.675,1.6.275A.938.938,0,0,0,.274,1.6L10.674,12,.274,22.4A.938.938,0,0,0,1.6,23.726L12,13.327l10.4,10.4A.938.938,0,0,0,23.725,22.4Z" transform="translate(0 -0.001)"/></g></g></svg>
		...
		<div class="modal fade" id="deleteFolder" tabindex="-1" role="dialog" aria-labelledby="#deleteFolderTitle" aria-hidden="true">
			<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="newFolderTitle"><span>XXXX</span></h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
						...
						<div class="account-block__form">
							<!-- <form> -->
								...
								<div class="row mb-3 js-row-field-list">
									<div class="col-12">
										<p class="new-field-wrap-title">Upload from device</p>
												...
												<div class="col-12">
													<div class="row new-field-wrap-table__body--row">
														<div class="col-5 new-field-wrap-table__body--file-name">
															<input type="text" class="image-data" name="file-name[]" value="example.jpg">
															<input type="text" class="image-data" name="file-size[]" value="30">
															<input type="text" class="image-data" name="image-type[]" value="image/jpeg">
															example.jpg
														</div>
														<div class="col-4 new-field-wrap-table__body--file-size">
															30 kb
														</div>
											...
											<div class="row new-field-wrap-table__footer">
												<div class="col-12">
													<div class="drop-input-wrap">
														...
														<input type="file" name="" id="" class="drop-input" accept="image/*">
													</div>
												</div>
											</div>
										</div>
