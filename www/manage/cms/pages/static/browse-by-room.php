...
<html lang="en">
	...
	<meta name="description" content="browse by room"><link href="app.css" rel="stylesheet"></head>
									...
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading">Browse by room</h2>
											</div>
										</div>
									</div>
									<div class="row">
						...
						<div class="row">
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Custom Closet Organizers for Wardrobes</p>
								</figure>
							</div>
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Deluxe wine racks</p>
								</figure>
							</div>
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Pantry storage</p>
								</figure>
							</div>
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Garage storage systems</p>
								</figure>
							</div>
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Laundry and craft storage</p>
								</figure>
							</div>
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Office organizations</p>
								</figure>
							</div>
							<div class="col-12 col-lg-4">
								<figure class="browse-by-room__figure">
									...
									<p class="browse-by-room__heading">Wall beds</p>
								</figure>
							</div>
