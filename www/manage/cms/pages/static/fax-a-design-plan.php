...
<html lang="en">
	...
	<meta name="description" content="fax a design plan"><link href="./app.css" rel="stylesheet"></head>
	<body>
									...
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading">Download and Print Our Fax
													Form</h2>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-12 col-lg-9 col-xl-9">
											<div class="simple-block__text">
												<p>
													Download, fill out and fax the following form to us with your
													specifications. Check out the form below for a sample. This is just
													an example as everyone's design will be different. If you have any
													questions, feel free to contact us at 1-888-312-7424.
												</p>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-12 col-xl-7 js-sample-fax-form">
								<div class="two-elements-block__wrapp.r">
									<h2 class="two-elements-block__wrapp.r--heading">Sample Fax Form</h2>
									<p class="two-elements-block__wrapp.r--text small-text js-show-text">Lorem ipsum
										dolor sit amet, consectetur adipiscing elit. Vestibulum egestas diam at arcu
										malesuada,
										a efficitur tortor congue. Morbi hendrerit ex in lacus efficitur euismod. Morbi
										risus orci, hendrerit at bibendum efficitur, molestie a ex.
										Morbi eget dui tincidunt, luctus diam sed, placerat ex. Nunc ut malesuada ante.
										<br><br>
										Praesent egestas consectetur volutpat. Morbi varius maximus iaculis. In a velit
										mollis, venenatis
										nibh eu, congue nulla. Praesent vitae ipsum ut sapien pretium tincidunt. Morbi
										dapibus nibh vitae elit blandit, et consectetur sem tempor.
										Etiam tristique est vel lacinia dignissim. Quisque facilisis, ligula ac volutpat
										porttitor, augue diam consequat metus, non dapibus sem metus
										libero.</p>

									<div class="two-elements-block__wrapp.r--link-block">
										<button data-readAll="Discover all" data-readLess="Discover less"
							...
							<div class="col-12 col-md-6 col-xl-5 js-sample-fax-form">
								<div class="two-elements-block__wrapp.r">
									<div class="two-elements-block__wrapp.r--content">
										<div class="two-elements-block__wrapp.r--image">
							...
							<div class="col-12 col-md-6 col-xl-12 js-read-review">
								<div class="two-elements-block__wrapp.r--stars fax-a-design">
									...
									<div class="stars-wrapp.r">
										<div class="block-stars__wrapp.r">
											<img src="images/Rectangle12.png" alt=""
												 class="block-stars__wrapp.r--image">
						...
						<div class="row">
							<div class="col-12 col-lg-6 js-tips-how-to-measure">
								<div class="no-shadow">
									...
									<h2 class="heading">Tips on how to measure</h2>
									...
									<div id="accordion">
										<div class="card-collapse">
											...
											<div id="collapse-one" class="collapse" aria-labelledby="heading-one"
												...
												<div class="card-collapse__body">
													...
													illum, neque dolor aliquam ea voluptatum necessitatibus explicabo
													quaerat ducimus at dolores debitis nisi nam facere sit recusandae
													quibusdam, quisquam id.
												</div>
											</div>
										</div>
										...
										<div class="card-collapse">
											<div class="card-collapse__header collapsed" id="heading-four"
										...
										<div class="card-collapse">
											<div class="card-collapse__header collapsed" id="heading-five"
											...
											<div id="collapse-five" class="collapse" aria-labelledby="heading-five"
												 data-parent="#accordion">
												<div class="card-collapse__body">
													Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis
													illum, neque dolor aliquam ea voluptatum necessitatibus explicabo
										...
										<div class="card-collapse">
											...
											<div id="collapse-six" class="collapse" aria-labelledby="heading-six"
												 data-parent="#accordion">
												<div class="card-collapse__body">
													Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis
													illum, neque dolor aliquam ea voluptatum necessitatibus explicabo
							...
							<div class="col-12 col-lg-6 p-0 p-lg-3 js-fax-your-project">
									...
									<table class="home-consult-form__image-area">
										...
										<tbody class="image-preview">
											...
											<tr>
												<td class="mobile-button-delete-wrap">
													<button class="mobile-button-delete js-delete-uploaded-img"
															data-image-name="example1.jpg" data-toggle="modal"
															data-target="#deleteImgModal"></button>
												</td>
												<td class="mobile-image-icon"><span class="mobile-image-container"
																					style="background: #7D9BC2;">jpg</span>
												...
												<td colspan="4">
													<div class="drop-region">
														<div class="drop-message">
															<svg id="add" xmlns="http://www.w3.org/2000/svg"
																...
																<g id="Group_376" data-name="Group 376">
																	<path fill="#384765" id="Path_195"
																		  data-name="Path 195"
																		  d="M14.3,0A14.3,14.3,0,1,0,28.6,14.3,14.316,14.316,0,0,0,14.3,0Zm8.342,14.9a.6.6,0,0,1-.6.6H15.491v6.554a.6.6,0,0,1-.6.6H13.7a.6.6,0,0,1-.6-.6V15.491H6.554a.6.6,0,0,1-.6-.6V13.7a.6.6,0,0,1,.6-.6h6.554V6.554a.6.6,0,0,1,.6-.6H14.9a.6.6,0,0,1,.6.6v6.554h6.554a.6.6,0,0,1,.6.6Z"></path>
																</g>
															</svg>
															...
															<input type="file" name="" id="" class="drop-region-input"
								...
								<!--
								.js-close-fax-design;  data-dismiss="modal" AND aria-label="Close" ARE FOR CLOSING THE MODAL
								-->
								<input type="submit"
									   name="send"
								...
								<div class="video-block__with-border">
									<div class="row">
										<div class="col-12">
											...
											<p class="video-block__text desktop-show">on how to measure the area
												correctly to ensure all things are taken into consideration such as base
												molding, windows,
												electrical outlets, attic and floor crawl spaces, heat registers
												etc..</p>
										</div>
									</div>
									<div class="row">
