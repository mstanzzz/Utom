...
<html lang="en">
	...
	<meta name="description" content="Video library detail page"><link href="./app.css" rel="stylesheet"></head>
	<body class="video-library-page">
...
?>
					...
					<div class="row">
						<div class="col-12">
							<div class="home-mobile-buttons-block__wrapp.r">
								<a href="video-library.html" title="" class="back-link">
		...
		<main class="main clearfix video-library">
						...
						<div class="row">
							...
							<div class="col-12 col-lg-3">
								<div class="specification-detial-header__link-wrap">
									<a href="video-library.html" title="" class="specification-detial-header__link">back
										to categories</a>
								</div>
							</div>
						</div>
			...
			<section class="category-block">
				<div class="wrapper">
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								<div class="category-block__filters video-library__filters">
									<div class="row  align-items-center">
										<div class="col-6 col-sm-4">
											<div class="category-block__filters--left-wrapp.r">
															...
															<li>
																<div data-select="select-option__sort-by"
																	...
																	<div class="select-custom__option__wrap">
																		<p class="select-custom__option__text">Sort
																			by</p>
																	</div>
																</div>
															</li>
										...
										<div class="col-6 col-sm-8">
											<div class="category-block__filters--right-wrapp.r">
					...
					<div class="js-list category-block__thumb" id="list-view">
						<div class="container-fluid">
							<ul id="html5-videos" class="row video-gallery">
								<li data-poster="images/vl1.jpg" data-sub-html="Product description 1"
									data-html="#video1" class="col-12 col-sm-6 col-md-3 col-lg-2">
									<a href="#" title="" class="video-library__detail">
										<div class="category-block__wrapp.r--image">
											<div class="video-library__detail-image">
												<img src="images/vl1.jpg"
													 alt=""
													 class="four-elements-block__wrapp.r--img img-fluid">
												<div class="video-thumb__layer">
													<div class="video-thumb__layer__icon">
														<svg class="video-overlay-play-button is-hidden"
															 viewBox="0 0 200 200"
															 alt="Play video">
											...
											<p class="video-thumb__text">Product description</p>
										</div>
									</a>
								</li>
								<li data-poster="images/vl1.jpg" data-sub-html="Product description 2"
									data-html="#video2" class="col-12 col-sm-6 col-md-3 col-lg-2">
									<a href="#" title="" class="video-library__detail">
										<div class="category-block__wrapp.r--image">
											<div class="video-library__detail-image">
												<img src="images/vl1.jpg"
							...
							<div style="display:none;" id="video1">
								<video class="lg-video-object lg-html5" controls preload=”metadata”>
									<source src="https://sachinchoolur.github.io/lightGallery/static/videos/video1.mp4"
											type="video/mp4">
					...
					<div class="category-block__bottom-line">
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="category-block__bottom-line--wrapp.r"></div>
								</div>
							</div>
						</div>
					</div>
...
?>
		...
		<div class="custom-fixed-modal" id="custom-fixed-modal">
			<div class="custom-fixed-modal__wrapp.r">
				...
				<div class="custom-fixed-modal__employee">
					...
					<a href="mailto:" title="" class="text-center">
						<p class="four-elements-block__wrapp.r--name">Product description</p>
						<p class="four-elements-block__wrapp.r--position">Closet Installation director</p>
						<p class="four-elements-block__wrapp.r--email"><span>@</span> employee@employee.employee</p>
					</a>
				</div>
