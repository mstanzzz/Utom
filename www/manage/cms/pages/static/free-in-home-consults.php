...
<html lang="en">
	...
	<meta name="description" content="free in home consults"><link href="./app.css" rel="stylesheet"></head>
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapp.r" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Free in home consults
										</li>
									</ul>
								</div>
							</div>
									...
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading text-center mb-1">Please fill out
													the form below and we'll get in touch with you soon!</h2>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-12 col-lg-8">
											<div class="consult-wrap__image-block justify-content-lg-start align-items-lg-start h-lg-100">
												<p class="consult-wrap__image-block--text">Lorem ipsum dolor sit amet,
												...
												<div class="desktop-show">
													<button class="consult-wrap__image-block--button"
															id="js-desktop-first-home-consult-form-btn">Explore your
														options
													</button>
												</div>
							...
							<div class="col-12 col-md-6">
								<div class="consult-wrap virtual-consultation">
									<div class="row">
										<div class="col-12 col-lg-4">
											<div class="consult-wrap__image-block right-border h-lg-100">
												<img src="images/virtual-reality.svg" alt=""
													 class="consult-wrap__image-block--img img-fluid">
										...
										<div class="col-12 col-lg-8">
											<div class="consult-wrap__image-block justify-content-lg-start align-items-lg-start h-lg-100">
												<p class="consult-wrap__image-block--text">Lorem ipsum dolor sit amet,
													...
													eirmod. tempor invidunt ut labore et dolore magna aliquyam erat, sed
													diam. voluptua.</p>
												<button class="consult-wrap__image-block--button">Virtual showroom
												</button>
											</div>
										</div>
									</div>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								...
								<div class="home-consult-form__wrapp.r">
									<div class="home-consult-form__nav">
										<button class="home-consult-form__nav--button"
												id="js-desktop-first-home-consult-nav-btn" disabled>1 Your Contact Info
										</button>
										<button class="home-consult-form__nav--button"
												id="js-desktop-second-home-consult-nav-btn" disabled>2 Your Project Info
										</button>
										<button class="home-consult-form__nav--button"
												id="js-desktop-third-home-consult-nav-btn" disabled>3 Attach an Image
										</button>
									</div>

									<div class="home-consult-form__content first-content"
										 id="js-mobile-first-home-consult-form">
										<h4 class="home-consult-form__heading desktop-show text-center">Your Contact
											Info</h4>
										<div class="form-group text-fields">
											<label class="mobile-show home-consult-form__label " for="names">Enter your
												full name</label>
											<input
													type="text"
													name="names"
										...
										<div class="desktop-show text-center">
											<button class="home-consult-form__submit mt-4"
									...
									<div class="home-consult-form__content second-content"
										...
										<h4 class="home-consult-form__heading text-center desktop-show">Your Project
											Info</h4>

										<div class="form-group datapicker-block">
											<label for="home-consult__modal-datepicker"
												   class="control-label datapicker-block__label">Proposed Finish
												Date</label>
										...
										<h4 class="home-consult-form__heading bordered-heading">Storage Areas <span>Which type of storage area are you interested in?</span>
										</h4>
										...
										<div class="home-consult-form__checkbox-block">
											...
											<div class="form-group bigger-text">
												<input class="custom-checkbox bigger-text" id="checkbox-5"
													   type="checkbox" value="value5">
											...
											<div class="form-group">
												<input class="custom-checkbox" id="checkbox-8" type="checkbox"
													   value="value8">
										...
										<div class="home-consult-form__select">
											<select name="states" id="">
												<option value="How did you hear about us?">How did you hear about us?
												</option>
									...
									<div class="home-consult-form__content third-content"
										...
										<h4 class="home-consult-form__heading text-center desktop-show">Attach an
											Image</h4>
											...
											<tbody class="image-preview">
												<tr>
													<td class="mobile-button-delete-wrap">
														<button class="mobile-button-delete js-delete-uploaded-img"
																data-image-name="example.jpg" data-toggle="modal"
																data-target="#deleteImgModal"></button>
													</td>
													<td class="mobile-image-icon"><span class="mobile-image-container"
																						style="background: #7D9BC2;">jpg</span>
													</td>
														...
														<div class="drop-region">
															<div class="drop-message">
																<svg id="add" xmlns="http://www.w3.org/2000/svg"
																	 width="28.6" height="28.6" viewBox="0 0 28.6 28.6">
																	<g id="Group_376" data-name="Group 376">
																		<path fill="#384765" id="Path_195"
																			  data-name="Path 195"
																...
																<input type="file" name="" id=""
																	   class="drop-region-input" accept="image/*"
																	   multiple>
															</div>
														</div>
													</td>
										...
										<div class="desktop-show text-center">
											<button class="home-consult-form__submit mt-4"
													id="js-desktop-last-home-consult-form-btn">submit your reqest
											</button>
										</div>
									</div>
								</div>
										...
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading services-mobile-black-title text-center">
													Once the design meets your requirements you can place your order and
													your
													closet will be manufactured and shipped to you for you to
													install.</h2>
											</div>
										</div>
									</div>
							...
							<div class="col-12 col-lg-4 catalog-block__content">
								<figure>
									...
									<figcaption>
										...
										<p class="simple-test">
											All closet organizers installed by our company include a purchaser's
											lifetime warranty
							...
							<div class="col-12 col-lg-4 catalog-block__content">
								<figure>
									...
									<figcaption>
										...
										<p class="simple-test">
											Visit America’s largest closet organizer showroom and design center to view
											a wide
											variety of organizers for your home or office.
											Located in Tigard, Oregon, it’s the perfect place to design your new closet
											organizer,
											pantry, garage system and more. Our showroom
											is open Monday through Friday 9:00AM - 5:00 PM and on the weekends by
											app.intment.
										</p>
									</figcaption>
								</figure>
