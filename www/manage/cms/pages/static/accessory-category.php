...
<meta name="description" content="Accessory Category page"><link href="./app.css" rel="stylesheet"></head>
...
?>
		...
		<section class="first-fixed-block covid-block clearfix">
			<figure class="first-fixed-block__img-group" style="background-image: url('images/accessory-category-header.jpg');">
				<figcaption class="first-fixed-block__img-group--text-block">
					...
					panels from Roseburg Forest Products Panolam, Flakeboard, 
					and other high quality American companies.
					</p>
				</figcaption>
			</figure>
		</section>
