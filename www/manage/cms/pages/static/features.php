						...
						<div class="row">
							...
							<div class="col-4 col-lg-3 second-header__search">
								...
								<div class="mobile-show">
									...
									<div class="mobile-show">
										<div class="account-block__navigation--wrapp.r">
								...
								<div class="simple-block__border no-border p-0">
									...
									<div class="row">
										<div class="clo-12 col-lg-2">
											<a href="specifications-details.html" title="" class="specification-link first-el-mobile-top-border">
										...
										<div class="clo-12 col-lg-2">
											<a href="specifications-details.html" title="" class="specification-link">
												<span class="specification-link__img">
				...
				<div class="container-fluid">
					<div class="row first-footer">
						<div class="col-12 col-lg-6 col-xl-3">
							<div class="first-footer__wrapp.r">
								<nav class="first-footer__wrapp.r--border">
									<button class="first-footer__wrapp.r-button js-show-mobile-footer-menu-btn">
						...
						<div class="col-12 col-lg-6 col-xl-3">
							<div class="first-footer__wrapp.r">
								<nav class="first-footer__wrapp.r--border js-show-all-footer-menu">
									<button class="first-footer__wrapp.r-button js-show-mobile-footer-menu-btn">
										<img src="images/app.ication.svg" alt="" class="first-footer__img">
					...
					<div class="row second-footer">
						<div class="col-12">
							<div class="second-footer__wrapp.r">
					...
					<div class="row third-footer">
						<div class="col-12 third-footer__wrapp.r">
