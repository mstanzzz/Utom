...
<html lang="en">
	...
	<meta name="description" content="account"><link href="app.css" rel="stylesheet"></head>
	<body>
						...
						<div class="col-12">
							<div class="home-mobile-buttons-block__wrapper">
								...
								<div class="account-nav__content">
									<a href="account.php" title="" class="home-mobile-buttons-block__link account-small-link active">Dashboard</a>
								...
								<div class="account-block__navigation--wrapper">
									...
									<nav class="account-block__navigation--navigation">
										<ul class="account-nav">
											...
											<li>
												<a href="account.php" title="" class="account-nav__link active account-menu-hidden">
													<svg xmlns="http://www.w3.org/2000/svg" width="20" height="19.575" viewBox="0 0 20 19.575">
														<path id="Path_210" data-name="Path 210" d="M90.589,177.888l-9.99,7.262v12.313h7.069v-9.036H93.41v9.036H100.6V185.151Z" transform="translate(-80.6 -177.888)" fill="#db440d"/>
													</svg>
													Dashboard
							...
							<div class="col-12 col-lg-9">
								...
								<div class="account-block__dashboard">
									<div class="account-block__dashboard-links">
										...
										<div class="account-block__dashboard-links--wrapper">
											<a href="account-orders.php" title="" class="account-block__dashboard-links--link-fixed"></a>
											...
											<div class=" account-block__dashboard-links--content my-order">
												...
												<div class="account-block__dashboard-links--holder">
													<a href="account-orders.php" title="" class="account-block__dashboard-links--link">View Order Receipt</a>
													<a href="account-orders.php" title="" class="account-block__dashboard-links--link">View all</a>
												</div>
											</div>
										</div>

										<div class="account-block__dashboard-links--wrapper">
											<a href="account-idea-folder.php" title="" class="account-block__dashboard-links--link-fixed"></a>

											<div class=" account-block__dashboard-links--content idea-folder">
												<div class="account-block__dashboard-links--heading-block">
													<p class="account-block__dashboard-links--heading">Idea folder</p>
													<img src="images/idfolder.svg" alt="" class="img-fluid">
												</div>
												
												<div class="account-block__dashboard-links--holder">
													<a href="account-idea-folder.php" title="" class="account-block__dashboard-links--link">View saved content</a>
												</div>
											</div>
										</div>

										<div class="account-block__dashboard-links--wrapper">
											<a href="account-settings.php" title="" class="account-block__dashboard-links--link-fixed"></a>
											...
											<div class=" account-block__dashboard-links--content my-account">
												...
												<div class="account-block__dashboard-links--holder">
													<a href="account-settings.php" title="" class="account-block__dashboard-links--link">Change Password</a>
													<a href="account-settings.php" title="" class="account-block__dashboard-links--link">Change Address</a>
													<a href="account-settings.php" title="" class="account-block__dashboard-links--link">Update Preferences</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="account-block__dashboard-static">
										...
										<div class="account-block__dashboard-static--wrapper design-tool">
											<p class="account-block__dashboard-static--image">
												<svg id="Group_156" data-name="Group156" xmlns="http://www.w3.org/2000/svg" width="40.378" height="24.672" viewBox="0 0 40.378 24.672">
