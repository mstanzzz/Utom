		...
		<div class="first-header__phone-card justify-content-center h-100">
			<div class="first-header__phone-card--phone">
				<div class="first-header__child">
					<a href="tel:999 999 9999" class="first-header__child__call" title="">
	...
	<div class="col-12 col-lg-4 desktop-show">
		<div class="first-header__phone-card pr-3">
					...
					<div class="dropdown dropdown-about">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<div class="dropdown-menu--content">
								...
								<a href="about-us.html" class="dropdown-item" title="">About us</a>
								
								<a href="services.html" class="dropdown-item" title="" >Services</a>
								
								<a href="support.html" class="dropdown-item" title="" >Support</a>
								
								<a title="" href="#" class="dropdown-item" title="" >For the Pro's</a>
								
								<a href="video-library.html" class="dropdown-item" title="" >Videos</a>
								
								<a href="" class="dropdown-item" title="" >Careers</a>
								<a href="" class="dropdown-item" title="" >Blog</a>
								<a href="" class="dropdown-item" title="" >Policies</a>
							</div>
						</div>
					</div>
				</div>
				<div class="first-header__child">
					<div class="dropdown dropdown-about js-account-wrap">
						<p class="dropdown-toggle account" id="dropdownAccountButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							...
							<span class="account-name">Hi, <?php echo $lgn->getFullName; ?></span>
						</p>
						<div class="dropdown-menu account" aria-labelledby="dropdownAccountButton">
							<div class="dropdown-menu--content">
								<a href="login.html" class="dropdown-item account-menu-visible js-account-login" title="" >Login</a>
								<a href="login.html" class="dropdown-item account-menu-visible" title="">Register</a>
								<?php
								if($_SESSION['customer_logged_in'] > 0){
								?>	
								<a href="account.html" class="dropdown-item account-menu-visible" title="">Dashboard</a>
								<a href="account-settings.html" class="dropdown-item account-menu-visible" title="">Account settings</a>
								<a href="" class="dropdown-item account-menu-visible" title="">Start a new design</a>
								<a href="account-orders.html" class="dropdown-item account-menu-visible" title="">My orders</a>
								<a href="account-payments.html"class="dropdown-item account-menu-visible" title="">Payment settings</a>
								<a href="account-idea-folder.html" class="dropdown-item account-menu-visible" title="">Idea folder</a>
								<a href="" class="dropdown-item account-menu-visible" title="">My designs</a>
								<a href="" class="dropdown-item account-menu-visible js-account-logout" title="">Sign out</a>
								<?php	
								}
								?>
							</div>
			...
			<div class="first-header__phone-card--card">
				...
				<a href="<?php echo SITEROOT."/checkout.html"; ?>" title="" data-toggle="checkout"
			...
			<div class="dropdown-checkout  curtain curtain-menu hide" data-toggle="checkout" id="curtain-menu">
				<div class="inner">
					...
					<div class="wrap-btn">
						<a href="shopping-cart.php"; ?>" title="" class="btn btn-primary btn-cart">
							view cart
						</a>
					</div>

<div class="inner">
<p class="text-lg text-center">sub total: 00</p>
<p class="wrap-btn">
<a href="" 
title="" class="btn btn-secondary btn-checkout btn-full">checkout</a>					
</p>
<p class=" text-center ">
<button class="btn-none text-small">
...
<li><a href="showroom-detail-view-categories.php" title="" class="active">Rooms</a></li>

<li><a href="features.php" title="">Features</a></li>

<li><a href="accessories.php" title="">Accessories</a></li>
...
<a href="fax-a-design-plan.php" title="">Fax a design</a>
<a href="free-in-home-consults.php" title="">Free in home consults</a>
<a href="we-design.php" title="">We Design</a>
<a href="you-design.php" title="">You Design</a>
</div>
</div>
</div>
</li>
<li><a href="diy-instructions.php" title="">Installation</a></li>
<li><a href="specifications.php" title="">Specs</a></li>
<li><a href="video-library.php" title="">Videos</a></li>
</ul>
</nav>
...
<div class="desktop-show">
<a href="we-design.php" title="" class="you-design">You design</a>
<a href="we-design.php" title="" class="we-design">We design</a>
</div>
...
<div class="wrap-btn">
<a href="#" title="" class="btn btn-primary btn-cart">
view cart
</a>
</div>
...
<div class="inner">
<p class="text-lg text-center">sub total: 99</p>
<p class="wrap-btn">
<a href="#" title=""
...
<li>
<a href="login.php" title="" class="account-nav__link account-mobile-menu-visible js-mobile-account-login">
login
</a>
</li>
<li>
...
<li>
<a href="<?php echo SITEROOT."/account-settings.html"; ?>" title=""
class="account-nav__link account-menu-hidden">
...
<li>
<a href="<?php echo SITEROOT."/you-design.html"; ?>" title=""
...
<li>
<a href="<?php echo SITEROOT."/account-orders.html"; ?>" title=""
class="account-nav__link account-menu-hidden svg-stroke">
<svg xmlns="http://www.w3.org/2000/svg" width="21"
...
<li class="mobile-show">
<a href="account-idea-folder.php" title=""
