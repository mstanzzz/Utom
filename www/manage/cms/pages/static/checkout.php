...
<html lang="en">
	...
	<meta name="description" content="checkout"><link href="./app.css" rel="stylesheet"></head>
							...
							<div class="col col-auto__custom">
												...
												<div class="address-shipping mt-4">
													<div class="address-shipping__customer">
														...
														<div class="form__add-new-address cd-none"
															...
															<form action="">
																<div class="home-consult-form__wrapp.r pb-2">
																	<fieldset>
																		<div class="form-row">
																			<div class="col">
																				<div class="form-group">
																					<label class="label-above"
																						   for="customer-new__name_collapsed">First
																						Name:</label>
																					<input id="customer-new__name_collapsed"
																						   type="text" name="name"
																						   placeholder="John"
																			...
																			<div class="col">
																				<div class="form-group">
																					<label class="label-above"
																						...
																						Name:</label>
																					<input id="customer-new__name-last_collapsed"
																						   type="text" name="name"
																						   placeholder="Doe"
																						   class="home-consult-form__input"/>
																				</div>
																		...
																		<div class="form-row">
																			...
																			<div class="col">
																				<div class="form-group">
																					<label class="label-above"
																						   for="customer-new__state_collapsed">State:</label>
																			...
																			<div class="col">
																				<div class="form-group">
																					<label class="label-above"
																						   for="customer-new__zip_collapsed">Zip:</label>
																			...
																			<div class="col">
																				<div class="form-group">
																					<label class="label-above"
																						   for="customer-new__state_collapsed">Country:</label>
																					<div class="home-consult-form__select ">
																						<select name="country"
																		...
																		<div class="mb-3">
																			...
																			<label class="label-above full"
																				   for="checkbox-product-1_collapsed">Set
																				as
																				default</label>
																		</div>
																		<div>
															...
															<div class="col">
																<div class="form-group">
																	...
																	<div class="select-custom"
																		 data-select="select-option__customer-address">
								...
								<div class="card card-checkout card-checkout__info">
									<div class="card-body">
										...
										<div class="row">
											<div class="col-lg-5">
												<h5 class="card-checkout__header card-el__hide-on-md">Payment
													Methods</h5>
												<!--SHOW THIS ON MOBILE SCREEN-->
											...
											<div class="col-lg-3">
												<!--SHOW THIS ON DESKTOP SCREEN-->
												<h5 class="card-el__hide-on-md card-checkout__header text-center btn-load-page"
													data-target="#modal__title">or use</h5>
												<!-- #SHOW THIS ON DESKTOP SCREEN-->
											...
											<div class="col-md-4 border-top__md border__gray mt-4 mt-lg-0">
												<h5 class="card-checkout__header card-checkout__header__border-top">
													Saved cards (4)</h5>
												<div class="address-shipping form__add-new-address">
													<div class="">
														<div class="row">
															<div class="col-12">
																<div class="form-group">
																	<p class="label-above">Choose one:</p>
																	<div class="select-custom"
																		 data-select="select-option__customer-address_2">
																		<div class="select-custom__box hover__rotate-angle">
																			<div class="home-consult-form__select__selected ">
											...
											<div class="card-checkout__product">
												<div class="row align-items-end align-items-lg-center">
													<div class="col card-checkout__product__title-wrap">
														<h5 class="card-checkout__product__title">Special title
															treatment</h5>
												...
												<p class="card-checkout__product__description card-el__hide-on-md">
													Packaged with 1 x #8 32 x 1'' screw, Easy to install. The classic
													knob.
														...
														<p class="card-checkout__product__label">
															...
															<span class="card-el__show-on-md icon-signature">
																<svg xmlns="http://www.w3.org/2000/svg" width="24.144"
																	 height="16.825" viewBox="0 0 24.144 16.825"><g
																		...
																		transform="translate(0 -172.603g></svg>
															</span>
																<!--SHOW THIS ON DESKTOP SCREEN-->
																<span class="card-el__hide-on-md">
																e-sign document
										...
										<div class="card-body card-order">
											...
											<div class="form-group form-promo">
												...
												<div class="form-row">
													...
													<div class="col-4">
														<button class="btn btn-primary btn-md">app.y</button>
													</div>
												</div>
											</div>
											<div class="order">
		...
		<div class="modal fade modal__add-address" id="modal__add-address" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="">
						<div class="modal__add-address-form__wrapp.r pb-2">
							<fieldset>
								<div class="form-row">
									<div class="col">
										<div class="form-group">
