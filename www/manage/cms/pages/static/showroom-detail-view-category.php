...
<html lang="en">
	...
	<meta name="description" content="showroom-detail-view-category"><link href="app.css" rel="stylesheet"></head>
	<body class="clearfix">

		<header class="header-covid showroom-category-page clearfix">
		...
		<section class="first-fixed-block covid-block showroom-category-page clearfix">
			<div class="mobile-show">
				<div class="mobile-category-heading">
					<p>Custom Closet Organizers for Wardrobes</p>
				</div>
			</div>
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page" title="">Master closet Organizers</li>
									</ul>
								</div>
							</div>
						</div>
								...
								<figure class="showroom-block__item">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<a href="showroom-detail-view-product.html" title="" class="link-button">
												Shop now
												<svg xmlns="http://www.w3.org/2000/svg" width="20.8" height="14.623" viewBox="0 0 20.8 14.623">
													<path id="left-arrow_3_" data-name="left-arrow(3)" d="M14.014,4.9a.737.737,0,1,0-1.048,1.038l5.314,5.314H.744A.738.738,0,0,0,0,11.982a.747.747,0,0,0,.744.744H18.281l-5.314,5.3a.752.752,0,0,0,0,1.048.734.734,0,0,0,1.048,0l6.573-6.573a.739.739,0,0,0,0-1.038Z" transform="translate(0.001 -4.676)"></path>
												</svg>
											...
											<button class="save-for-idea" data-img-path="images/showroom-1.png" tabindex="0">
								...
								<figure class="showroom-block__item">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-2.png" tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button>
										</div>
									</figcaption>
								...
								<figure class="showroom-block__item">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-3.png" tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
									</figcaption>
								...
								<figure class="showroom-block__item">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-4.png" tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
									</figcaption>
								...
								<figure class="showroom-block__item">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-5.png" tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
									</figcaption>
								...
								<figure class="showroom-block__item">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-6.png" tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
									</figcaption>
