...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <meta name="description" content="ORDER FULFILLMENT DASHBOARD_STEP 4 ORDER FULFILLMENT STATUS_STEP HISTORY MINIMIZED_PAUSE_REASON_SUBMITTED">
    <title>ORDER FULFILLMENT DASHBOARD_STEP 4 ORDER FULFILLMENT STATUS_STEP HISTORY MINIMIZED_PAUSE_REASON_SUBMITTED</title>
  ...
  <body>
    ...
    <div class="order-fulfillment-dashboard-popup-container">
      ...
      <div class="order-fulfillment-dashboard-popup">
        ...
        <div class="ofd-popup-submitted-icon">
          <img src="./assets/img/icon-submitted.png" alt="Pause Reason Submitted">
        </div>

        <div class="ofd-popup-submitted-title">
          Step 01. has been successfully paused
        </div>

        <div class="ofd-popup-submitted-subtitle">
          Room 03, CLOSET #01 is now paused with
        </div>

        <div class="ofd-popup-pause-reason-text">
          MISSING EQUIPMENT
        </div>

        <div class="ofd-close-button">
          <a href="#">
            CLOSE
          </a>
        </div>
