...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Installer Job Dashboard APP_Main Page_Google Navigation Map_Show Traffic">
    <title>Installer Job Dashboard APP_Main Page_Google Navigation Map_Show Traffic</title>
        ...
        <div class="gnMap-content installer-dashboard-gnMap-home-page">
          ...
          <main class="ijd-gnMap-main-content">
            ...
            <div class="ijd-gnMap-mc-map-container">
              ...
              <div class="ijd-gnMap-mc-turn-on-location-service-container">
                <div class="ijd-gnMap-mc-turn-on-location-service-title">
                  TURN ON LOCATION SERVICE?
                </div>
                <div class="ijd-gnMap-mc-turn-on-location-service-buttons">
                  <div class="ijd-gnMap-mc-turn-on-location-service-buttons-link ijd-gnMap-mc-tolsb-yes">
                    <a href="<?php echo SITEROOT; ?>/manage/dashboard/installer/#">YES</a>
                  </div>
                  <div class="ijd-gnMap-mc-turn-on-location-service-buttons-link ijd-gnMap-mc-tolsb-cancel">
                    <a href="<?php echo SITEROOT; ?>/manage/dashboard/installer/#">CANCEL</a>
                  </div>
