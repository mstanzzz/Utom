...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <meta name="description" content="ORDER FULFILLMENT DASHBOARD_STEP 4 ORDER FULFILLMENT STATUS_FULL_STEP HISTORY MINIMIZED">
    <title>ORDER FULFILLMENT DASHBOARD_STEP 4 ORDER FULFILLMENT STATUS_FULL_STEP HISTORY MINIMIZED</title>
    ...
    <div class="order-fulfillment-main-container">
      ...
      <div class="content-container left-sidebar-expanded">
        ...
        <section class="io-content inbound-orders-order-rooms">
          ...
          <main class="order-fulfillment-dashboard-step-history-minimized-container step-history-sidebar-open">

            <div class="order-fulfillment-dashboard-step-history-minimized">

              <section class="ofds4-content">

                <div class="ofds4-shm-closet-menu">
                  <select class="" name="">
                ...
                <div class="ofds4-shm-steps-menu">
                  <select class="" name="">
                ...
                <div class="ofds4-shm-chart-buttons-container">
                  ...
                  <div class="ofds4-shm-chart-buttons">
                    ...
                    <div class="ofds4-chart-container">
                      <section class="ofds4-chart">
                        <svg class="circle-chart-outer" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <circle class="shm-circle-chart-outer-circle" cx="14" cy="14" r="13.66" />
                        </svg>

                        <svg class="circle-chart-inner" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                          <linearGradient id="shm-circle-chart-inner-gradient" x1="100%" y1="0%" x2="0%" y2="0%">
                        ...
                        <div class="circle-chart-info-container">
                          ...
                          <div class="shm-cci-status">
                            <img src="./assets/img/icon-paused-shm.png" alt="">
                            <span>Paused</span>
                          </div>
                    ...
                    <div class="ofds4-shm-step-process-badge-container">
                      <div class="ofds4-shm-step-process-badge">

                      </div>
                      <span>Step Process</span>
                    </div>

                    <div class="ofds4-shm-overall-job-expected-completion-container">
                      <div class="ofds4-shm-overall-job-expected-completion-badge">
                    ...
                    <div class="ofds4-resume-button">
                      <a href="#">
                        <span>Resume</span>
                        <img src="./assets/img/icon-resume.png" alt="Start">
                      </a>
                    </div>

                    <div class="shm-ofds4-status-reason-box">
                      <div class="shm-ofds4-status-reason-title">
                        Step has been paused with reason of
                      </div>
                      <div class="shm-ofds4-status-reason-text">
                        MISSING EQUIPMENT
                      </div>
                    </div>
