...
if(!isset($_SESSION['temp_page_fields']['hide'])) $_SESSION['temp_page_fields']['hide'] = 1;
if(!isset($_SESSION['temp_page_fields']['when_active'])) $_SESSION['temp_page_fields']['when_active'] = 0;
if(!isset($_SESSION['temp_page_fields']['when_expired'])) $_SESSION['temp_page_fields']['when_expired'] = 0;
...
if(!isset($_SESSION['temp_page_fields']['coupon_code'])) $_SESSION['temp_page_fields']['coupon_code'] = '';
if(!isset($_SESSION['temp_page_fields']['percent_off'])) $_SESSION['temp_page_fields']['percent_off'] = '';
if(!isset($_SESSION['temp_page_fields']['amount_off'])) $_SESSION['temp_page_fields']['amount_off'] = '';
if(!isset($_SESSION['temp_page_fields']['if_greater_than'])) $_SESSION['temp_page_fields']['if_greater_than'] = 0;
if(!isset($_SESSION['temp_page_fields']['if_less_than'])) $_SESSION['temp_page_fields']['if_less_than'] = 0;
if(!isset($_SESSION['temp_page_fields']['can_use_with_other_discounts'])) $_SESSION['temp_page_fields']['can_use_with_other_discounts'] = 1;
...
<div class="lightboxholder">
	...
	?>
	<form name="form" action="<?php echo $url_str; ?>" method="post" onSubmit="return validate(this)" enctype="multipart/form-data" target="_top">
...
-->	
<textarea name="description"><?php echo ($_SESSION['temp_page_fields']['description']); ?></textarea> 
					</div> 
				</div>stripslashes
				<div class="colcontainer formcols">
					<div class="twocols">
...
<?php //echo "hide:".$_SESSION['temp_page_fields']['hide']; ?>
        ...
        if($admin_access->ecommerce_level > 1){
            echo "<button class='btn btn-success btn-large' name='add_global_discount' type='submit' value='Submit'><i class='icon-ok icon-white'></i> Save Changes</button>"; 
        }else{?>
