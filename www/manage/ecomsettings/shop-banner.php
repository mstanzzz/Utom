...
if(isset($_POST["add_banner"])){
	...
	//if(in_array(2,$user_functions_array)){
		...
		$url, $img_id, 'shop', $img_alt_text, $_SESSION['profile_account_id']);
...
<div class="manage_page_container">
    ...
    <div class="manage_main">
		...
		?>
		<form name="form" action="shop-banner.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="set_active" value="1">
			<?php if($admin_access->ecommerce_level > 1){ ?>	
				<div class="page_actions">
					<a class="btn btn-large btn-primary fancybox fancybox.iframe" href="add-showroom-banner.php?ret_page=shop-banner.php"><i class="icon-plus icon-white"></i> Add a New Shop Banner </a>
