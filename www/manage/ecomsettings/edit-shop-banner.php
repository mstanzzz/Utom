...
<div class="lightboxholder">
	...
	?>
	<form name="edit_banner" action="shop-banner.php" method="post" target="_top" onSubmit="return validate(this)"  enctype="multipart/form-data">
		<div class="lightboxcontent">
			<h2>Editing Shop Banner</h2>
