...
<div class="lightboxholder">
	...
	?>
	<form name="add_banner" action="shop-banner.php" method="post" target="_top" onSubmit="return validate(this)"  enctype="multipart/form-data">
		<div class="lightboxcontent">
			<h2>Add a New Shop Banner</h2>
			<fieldset class="colcontainer">
				...
				<div class="twocols">
					...
					<?php
						...
						$url_str .= "?ret_page=add-shop-banner";
