			...
			<div class="row">
				<div class="col-12 col-lg-4 first-header__shipping">
					<a href="#" class="first-header__child">
						<img src="<?php echo $ste_root."images/security.svg"; ?>" alt=""/>
						100% Perfect fit guarantee
					</a>
				<a href="#" class="first-header__child">
					<img src="<?php echo $ste_root."images/delivery-truck(2).svg"; ?>" alt="" class="truck-image"/>
					free shipping
				</a>
			</div>
				...
				<div class="first-header__phone-card justify-content-center h-100">
					<div class="first-header__phone-card--phone">
						<div class="first-header__child">
							...
							<img src="<?php echo $ste_root."images/call-answer.svg"; ?>" alt="" class="phone-image"/>
							<?php 
...
<a class="dropdown-item" title="" href="<?php echo $ste_root."about-us.html"; ?>">About us</a>
<a class="dropdown-item" title="" href="<?php echo $ste_root."services.html"; ?>">Services</a>
<a class="dropdown-item" title="" href="<?php echo $ste_root."support.html"; ?>">Support</a>
...
<a class="dropdown-item account-menu-hidden" title="" href="<?php echo $ste_root."you-design.html"; ?>">Start a new design</a>
<a class="dropdown-item account-menu-hidden" title="" href="<?php echo $ste_root."account-orders.html"; ?>">My orders</a>
<a class="dropdown-item account-menu-hidden" title="" href="<?php echo $ste_root."account-payments.html"; ?>">Payment settings</a>
<a class="dropdown-item account-menu-hidden" title="" href="<?php echo $ste_root."account-idea-folder.html"; ?>../../.html">Idea folder</a>
<a class="dropdown-item account-menu-hidden" title="" href="<?php echo $ste_root."account.html"; ?>">My designs</a>
<a class="dropdown-item account-menu-hidden js-account-logout" title="" href="#">Sign out</a>
					...
					<div class="first-header__phone-card--card">
						...
						<div class="first-header__child wrap-save">
							<a href="#" title="">
								<img src="<?php echo $ste_root."images/icon-save.svg"; ?>" alt=""/></a>
...
<img src="<?php echo $ste_root."images/images/checkout.svg"; ?>" alt="" class="shopping-bag"/>
...
<img class="img img-fluid" src="<?php echo $ste_root."images/images/icon-close.svg"; ?>" alt="">
																		</div>
																	</li>
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
<img class="img img-fluid" src="<?php echo $ste_root."images/images/icon-save.svg"; ?>" alt="">
																		</div>
																	</li>
																</ul>
															</div>
															<a href="#" title="" class="media-link">
																<div class="media">
																	<div class="wrap-img">
<img class="img-fluid img" src="<?php echo $ste_root."images/images/team-1.png"; ?>" alt="Generic placeholder image">
																	</div>
														...
														<div class="item">
															<div class="list-item__options">
																<ul class="list-item__options__list">
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
<img class="img img-fluid" src="<?php echo $ste_root."images/security.svg"; ?>" alt="">
																		</div>
																	</li>
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
<img class="img img-fluid" src="<?php echo $ste_root."images/icon-save.svg"; ?>" alt="">
																		</div>
																	</li>
																</ul>
															</div>
															<a href="#" title="" class="media-link">
																<div class="media">
																	<div class="wrap-img">
<img class="img-fluid img" src="<?php echo $ste_root."images/team-1.png"; ?>" alt="Generic placeholder image">
																	</div>
																	<div class="media-body">
																		<h5 class="item-title">Yaka pichka pod naem s mnogo eftino obeshtawam</h5>
																		<div class="item-info">
														...
														<div class="item">
															<div class="list-item__options">
																<ul class="list-item__options__list">
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
<img class="img img-fluid" src="<?php echo $ste_root."images/icon-close.svg"; ?>" alt="">
																		</div>
																	</li>
																	<li class="list-item__options__list-option">
																		<div class="list-item__options__list-option__wrap list-item__options__list-option__close">
...
<img class="img-fluid img" src="<?php echo $ste_root."images/team-1.png"; ?>" alt="Generic placeholder image">
											...
											<div class="wrap-btn">
<a href="<?php echo $ste_root."shopping-cart.html"; ?>" title="" class="btn btn-primary btn-cart">view cart</a>
											</div>
											<div class="inner">
												<p class="text-lg text-center">sub total: $543.34</p>
												<p class="wrap-btn">
<a href="<?php echo $ste_root."checkout.html"; ?>" title="" class="btn btn-secondary btn-checkout btn-full">checkout</a>
												</p>
												<p class=" text-center ">
						...
						<div class="row">
							<div class="col-8 col-lg-9 second-header__logo-nav">
								...
								<div class="second-header__logo-nav--logo">
									<a href="../../">
<img src="<?php echo $ste_root."images/svgg.svg"; ?>" alt="" />
									</a>
								</div>
									...
									<ul>
										<li class="mobile-show">
											<div class="mobile-hide-nav">
												...
												<a href="<?php echo $ste_root ?>" title="">Home</a>
											</div>
										</li>
...
<li><a href="<?php echo $ste_root."shop.html"; ?>" title="">Accessories</a></li>
										<li><a href="#" title="">Why Closets To Go</a></li>
										<li>
											<div class="second-header__logo-nav--grop-down">
												<span>
													Process
<img class="icon__plus" src="<?php echo $ste_root."images/minus-button-1.svg"; ?>" alt="">
<img class="icon__minus" src="<?php echo $ste_root."images/minus-button.svg"; ?>" alt="" style="display: none;">
												</span>
												<div class="dropdown-wrap">
													<div class="dropdown-content">
<a href="<?php echo $ste_root."fax-a-design-plan.html"; ?>" title="">Fax a design</a>
<a href="<?php echo $ste_root."free-in-home-consults.html"; ?>" title="">Free in home consults</a>
<a href="<?php echo $ste_root."we-design.html"; ?>" title="">We Design</a>
<a href="<?php echo $ste_root."you-design.html"; ?>" title="">You Design</a>
													</div>
												</div>
											</div>
										</li>
<li><a href="<?php echo $ste_root."diy-instructions.html"; ?>" title="">Installation</a></li>
<li><a href="<?php echo $ste_root."specifications.html"; ?>" title="">Specs</a></li>
...
<a href="<?php echo $ste_root."we-design.html"; ?>" title="" class="we-design">We design</a>
								</div>

								<button id="show-search-form" class="header__btn-search__wrap">
<img src="<?php echo $ste_root."images/search(1).svg"; ?>" alt="">
								</button>
								<div class="mobile-show">
									<div class="first-header__phone-card--card">
...
<img src="<?php echo $ste_root."images/call-answer-mobile.svg"; ?>" alt="" class="mobile-icon">
										</a>

										<button class="first-header__child js-show-user-nav">
<img src="<?php echo $ste_root."images/user-blue.svg"; ?>" alt=""/>
										</button>
										<a href="#" title="" data-toggle="checkout"	class="first-header__child toggleMenu first-header__open__dropdown-checkout" id="toggleMenu">
<img src="<?php echo $ste_root."images/checkout-blue.svg"; ?>" alt=""/>
											<span class="badge badge-danger badge-round">3</span>
										</a>
									</div>
									<div class="dropdown-checkout curtain curtain-menu hide" data-toggle="checkout" id="curtain-menu">
...
<img src="<?php echo $ste_root."images/team-3.png"; ?>" alt="" class="img-fluid">
													</span>
									...
									<nav class="account-block__navigation--navigation">
										<ul class="account-nav">
											...
											<li>
<a href="<?php echo $ste_root."account.html"; ?>" title="" class="account-nav__link account-menu-hidden">
											...
											<li>
<a href="<?php echo $ste_root."account-settings.html"; ?>" title="" class="account-nav__link account-menu-hidden">
...
<a href="#" title="" class="account-nav__link account-menu-hidden svg-stroke">
											...
											<li>
<a href="<?php echo $ste_root."account-orders.html"; ?>" title="" class="account-nav__link account-menu-hidden svg-stroke">
											...
											<li>
<a href="<?php echo $ste_root."account-payments.html"; ?>" title="" class="account-nav__link account-menu-hidden">
											...
											<li class="mobile-show">
<a href="<?php echo $ste_root."account-idea-folder.html"; ?>" title="" class="account-nav__link account-menu-hidden">Idea folder</a>
											</li>
											<li class="mobile-show">
