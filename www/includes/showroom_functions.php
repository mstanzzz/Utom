...
function getSearchShowroomItemBar($num_res)
{
	...
	$block .="<div style='padding-left:8px;  padding-top:5px; float:left;'><img src='".$_SERVER['DOCUMENT_ROOT']."/images/icons/list.gif' /></div>";
	...
	$block .="<div style='padding-left:20px;  padding-top:5px; float:left;'><img src='".$_SERVER['DOCUMENT_ROOT']."/images/icons/grid.gif' /></div>";
