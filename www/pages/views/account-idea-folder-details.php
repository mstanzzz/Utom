...
<section class="mobile-order-search covid-block mobile-idea-folder mobile-idea-folder--details js-mobile-idea-folder-header">
	...
	<div class="mobile-idea-folder--details__wparpper">
		...
		<button class="account-mobile-more-info-btn idea-folder-details js-show-mobile-action-btn"></button>
...
<p class="first-text">
Title house name: <?php echo $main_idea_folder_name; ?>
</p>
												</div>
											</div>
											<div class="row w-100">
...
-->
<img src="<?php echo $main_idea_folder_blob_image;  ?>" alt="" class="img-fluid">
	...
	<div class="col-12 js-specification-sheet-box" style="display: none;">
		<div class="folder-wrapper__specification-sheet--wrapper">
			...
			<div class="folder-wrapper__specification-sheet--wrapper-content">
				<h3 class="folder-wrapper__specification-sheet--wrapper-heading">Accessory</h3>				<div class="folder-wrapper__specification-sheet--wrapper-image-wrap">
