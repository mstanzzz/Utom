...
<input type="hidden" name="from_design_options_page" value="1">
	...
	<div class="row showroom-detail-product-row">
		<div class="col-12 col-lg-6 showroom-detail-product-col-lg mt-3">
			<div class="form-group">
				<input type="text" class="form-control we-design-block__form--input" name="first_name" placeholder="First name">
			</div>
		</div>
		<div class="col-12 col-lg-6 showroom-detail-product-col-lg  mt-3">
			<div class="form-group">
				<input type="text" class="form-control we-design-block__form--input" name="last_name" placeholder="Last name">
			</div>
		</div>
	</div>
	<div class="row showroom-detail-product-row">
		...
		<div class="col-12 col-lg-6 showroom-detail-product-col-lg mt-3">
			<div class="form-group">
				<input type="text" class="form-control we-design-block__form--input" name="zip" placeholder="Zip code">
			</div>
		</div>
	</div>
	<div class="row showroom-detail-product-row">
...
<div class="five-elements-block__wrapper video-second-caro">
	...
	<div class="five-elements-block__wrapper--item">
		<a href="<?php echo SITEROOT."/you-design.html"; ?>">
			<figure>
				<div class="five-elements-block__wrapper--image">
...
//echo $yuwedes_btns_mobile_section;
