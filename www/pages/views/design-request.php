...
//$sql = "DELETE FROM design_email WHERE email = 'test@'";
//$sql = "DELETE FROM design_email WHERE name = 'qwe qwe'";
//$sql = "DELETE FROM design_email WHERE email LIKE '%mstanzzz@%'";
//$result = $dbCustom->getResult($db,$sql);


$another = isset($_POST['another'])? 1 : 0;

if($another && isset($_SESSION['designrequest']['email'])){
...
$( document ).ready(function() {
	...
	$("#door_type").change(function() {
		...
		var content = "<img src='<?php echo SITEROOT; ?>DF_images/designform/"+img_name+".png' />";
...
function set_wall_meas_content(closet_type){
		...
		if(closet_type.search("each-in") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-reach-in-c.png' />";					
		...
		if(closet_type.search("quare") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-square-c.png' />";
		...
		if(closet_type.search("shape_2") > -1){
			walls_content = "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-l-shape_2-c.png' />";
		...
		if(closet_type.search("shape_3") > -1){
			...
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-l-shape_3-c.png' />";
		...
		if(closet_type.search("shape_4") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-l-shape_4-c.png' />";
		...
		if(closet_type.search("shape_1") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-l-shape_1-c.png' />";
		...
		if(closet_type.search("ngle-1") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-angle-1-c.png' />";
		...
		if(closet_type.search("ngle-2") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-angle-2-c.png' />";
		...
		if(closet_type.search("ngle-3") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-angle-3-c.png' />";
		...
		if(closet_type.search("ngle-4") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-angle-4-c.png' />";
		...
		if(closet_type.search("ngle-5") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-angle-5-c.png' />";
		...
		if(closet_type.search("ngle-6") > -1){
			walls_content += "<img width='272' src='<?php echo SITEROOT; ?>DF_images/designform/large-angle-6-c.png' />";
...
<body style="background-color:#6495ED;">
	...
	<div class="span12" style="margin:20px; padding:10px;background-color:white;">

   
    <h1 style="color:#6495ED;">We Design</h1>
    
	<div style="font-size:1.2em; color:#6495ED;">
	...
	<form name="form" action="<?php echo SITEROOT.'email-design-confirm.html'; ?>" method="post" enctype="multipart/form-data">
        ...
        From the selection below, choose the closet type and shape that most closely matches the appearance of your closet.
       	...
       	<div style="width:240px; text-align:center; font-size:18px; border-bottom-style:solid; border-bottom-width:thin;">Reach-In</div>
             <div class="design_form_closet_type">
             	<img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/reach-in.png" alt="Reach-in" />
			</div>
        <br />
        <div style="clear:both;"></div>
        ...
        <div style="width:100%;">
                ...
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/square.jpg" alt="Square"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/l-shape_2.jpg" alt="L-shape_2"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/l-shape_3.jpg" alt="L-shape_3"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/l-shape_4.jpg" alt="L-shape_4"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/l-shape_1.jpg" alt="L-shape_1"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/angle-1.jpg" alt="Angle-1"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/angle-2.jpg" alt="Angle-2"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/angle-3.jpg" alt="Angle-3"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/angle-4.jpg" alt="Angle-4"  />
                </div>
                
                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/angle-5.jpg" alt="Angle-5"  />
                </div>

                <div class="design_form_closet_type">
                    <img class="design_form_closet_type_img" src="<?php echo SITEROOT; ?>DF_images/designform/angle-6.jpg" alt="Angle-6"  />
                </div>
            	<div style="clear:both;"></div>
        </div>
        <div style="clear:both"></div>
		...
		<br />
			<div class="finish_container">
                <div style="float:left;">
                	<img src="<?php echo SITEROOT; ?>DF_images/finishes/finish_white.jpg" alt="Closet Finish"/>
                </div>
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/finish_antique_white.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/finish_almond.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/custom-grey.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/negotiating-in-geneva.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/hardrock-maple.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/backwoods-sycamore.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/sunset-cherry.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">            
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/closets-to-go-rustik-cherry.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/rustic-alder.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/american-black-walnut.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/finish_chocolate_pear.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/windsor-mahogany.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">        
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/african-mahogany.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">   
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/black.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-diva.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-vanilla-stix.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-aria.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-sandalwood.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-stromboli.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-driftwood.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-pewter-pine.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-zambukka.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-libretti.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-mochatini.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-linear-ash.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">			
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-verismo.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
			...
			<div class="finish_container">            
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/n-queenston-oak.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
            ...
            <div class="finish_container">
                <div style="float:left;">
                <img src="<?php echo SITEROOT; ?>DF_images/finishes/finish_other.jpg" alt="Closet Finish"/>
                </div>
                <div style="float:left; margin-left:6px; margin-top:6px;">
	...
	<br />
        ...
        <img src="<?php echo SITEROOT; ?>DF_images/design_submit_round.png" /></a>
