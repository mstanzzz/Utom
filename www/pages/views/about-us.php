...
<div class="wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 col-md-6">
				<div class="two-elements-block__wrapper">
					...
					<div class="simple-block__text desktop-show">
						...
						<p class="bolded-text">
						<?php 					
						echo "Call today! ".$comp_basic['phone']; 
						?>	
						</p>
					</div>
				</div>
			...
			<div class="col-12 col-md-6">
				<div class="two-elements-block__wrapper">
				<img src="<?php echo SITEROOT; ?>images/woman-working-office.jpg" alt="" class="img-fluid">
				</div>
			</div>
...
<div class="wrapper">
	<div class="container-fluid">
		<div class="row">
			...
			<img src="<?php echo SITEROOT; ?>images/who-we-are-1.png" alt="" >
			</div>
			<div class="col-6 col-lg-3 company-block__images">
			<img src="<?php echo SITEROOT; ?>images/who-we-are-2.png" class="img-fluid" alt="">
			</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-12 col-lg-7">
				...
				<img src="<?php echo SITEROOT; ?>images/about-us-prod.png" alt="" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
