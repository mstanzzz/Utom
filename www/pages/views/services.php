								...
								<div class="col-12">
									<div class="simple-block__heading">
										<h2 class="simple-block__heading--heading mobile-show services-title">
											For our customers simplifying the installation process
										</h2>
										<h2 class="simple-block__heading--heading desktop-show services-title">
										<!-- For our customers	-->
										<?php echo $top_1; ?>
										</h2>
										...
										<h2 class="simple-block__heading--heading desktop-show services-title about-us-heading-26">
...
<h2 class="block-with-background__content--subheading">
<!-- Pre-Assemble all the hardware in every part -->
<?php												
echo $p_1_text;
?>
</h2>
	...
	<div class="row">
		<div class="col-12">
			<div class="simple-block__heading">
				<h2 class="simple-block__heading--heading about-us-heading-24 mb-2">
<!-- We offer in-home consultations for our local customers and free design service for our out of state customers. -->
<?php
echo $p_2_text;
?>				
				</h2>
...
<!--
Our in-home consultations provide you with assistance measuring your space and determining your needs. 
From start to finish your designer is with you to answer questions and help maximize your space. 
Once your order is placed and manufactured, our installation team will call to schedule your professional closet installation.
-->		
<?php
echo $p_3_text;
?>				
...
?>				
<!--
For our valued customers around the country, we offer online design assistance. 
Simply start by going to Closets To Go, click on the “Start Designing” link in 
the orange box in the right hand corner that reads “Get Your Custom Closet In 
3 Easy Steps.” Click on the orange “Request Design” box.
-->
</p>
</div>
</div>
...
<!--
Once the design meets your requirements you can place your order and your closet will be manufactured and shipped to you for you to install.
-->
<?php
echo $p_6_text;
?>				
...
<p class="simple-test">
<!--
We offer many custom choices ranging from custom designs, colors to accessories that fit your style and needs.
-->
<?php echo $p_7_text ?>
...
<p class="simple-test">
<!--
All closet organizers installed by our company include a purchaser's lifetime warranty covering material defects and workmanship. See policies page for more information.
-->
<?php echo $p_8_text; ?>
...
<h2>
<?php echo $p_9_head; ?>
<!-- Showrom-Design Center --> 
</h2>
<p class="simple-test">
<?php echo $p_9_text; ?>
<!--
Visit America’s largest closet organizer showroom and design center to view a wide variety of organizers for your home or office.
Located in Tigard, Oregon, it’s the perfect place to design your new closet organizer, pantry, garage system and more. Our showroom
