...
/*
	...
	echo "<br />top_2: ".$top_2;
	echo "<br />top_3: ".$top_3;
	echo "<br />p_1_head: ".$p_1_head;
	echo "<br />p_1_text: ".$p_1_text;
	echo "<br />p_2_head: ".$p_2_head;
	echo "<br />p_2_text: ".$p_2_text;
	echo "<br />p_3_head: ".$p_3_head;
	echo "<br />p_3_text: ".$p_3_text;
	echo "<br />p_4_head: ".$p_4_head;
	echo "<br />p_4_text: ".$p_4_text;
	echo "<br />p_5_head: ".$p_5_head;
	echo "<br />p_5_text: ".$p_5_text;
	echo "<br />p_6_head: ".$p_6_head;
	echo "<br />p_6_text: ".$p_6_text;
	echo "<br />p_7_head: ".$p_7_head;
	echo "<br />p_7_text: ".$p_7_text;
	echo "<br />p_8_head: ".$p_8_head;
	echo "<br />p_8_text: ".$p_8_text;
	echo "<br />p_9_head: ".$p_9_head;
	echo "<br />p_9_text: ".$p_9_text;
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item">
											<a href="about-us.html?ret_page=HHHHHHH">About us</a>
										</li>
										...
										<li class="breadcrumb-item active" aria-current="page">
											<a href="fax-a-design-plan.html">We-design-fax</a>
										</li>
									</ul>
								</div>
							</div>
...
//Download, fill out and fax the following form to us with your specifications. Check out the form below for a sample. This is just an example as everyone's design will be different. If you have any questions, feel free to contact us at 1-888-312-7424. 
?>
						...
						<div class="row">
							<div class="col-12">
								<div class="fax-design-mobile-buttons">
									<button class="fax-design-mobile-button js-mobile-fax-design-content-btn" date-content-class-open=".js-sample-fax-form" data-toggle="modal" data-target="#mobile-fax-design">Sample Fax Form</button>
									<button class="fax-design-mobile-button js-mobile-fax-design-content-btn" date-content-class-open=".js-tips-how-to-measure" data-toggle="modal" data-target="#mobile-fax-design">Tips on how to measure</button>
									<button class="fax-design-mobile-button js-mobile-fax-design-content-btn" date-content-class-open=".js-fax-your-project" data-toggle="modal" data-target="#mobile-fax-design">Fax us your idea project</button>
									<button class="fax-design-mobile-button js-mobile-fax-design-content-btn" date-content-class-open=".js-read-review" data-toggle="modal" data-target="#mobile-fax-design">Read Our Reviews</button>
								</div>
							</div>
						</div>
					</div>
...
Morbi eget dui tincidunt, luctus diam sed, placerat ex. Nunc ut malesuada ante. Praesent egestas consectetur volutpat. Morbi varius maximus iaculis. In a velit mollis, venenatis nibh eu, congue nulla. Praesent vitae ipsum ut sapien pretium tincidunt. Morbi dapibus nibh vitae elit blandit, et consectetur sem tempor. 
Etiam tristique est vel lacinia dignissim. Quisque facilisis, ligula ac volutpat porttitor, augue diam consequat metus, non dapibus sem metus libero.
*/
?>										
									</p>
...
?>												
										...
										<div class="card-collapse">
														<div class="card-collapse__header collapsed" id="heading-four" data-toggle="collapse" data-target="#collapse-four" aria-expanded="false" aria-controls="collapse-four">														<h5 class="card-collapse__title">
<?php
...
<?php
echo "p_10_head: ".$p_10_head;							
//Watch some videos
?>											
											</h2>
											<p class="video-block__text desktop-show">
<?php
echo "p_10_text: ".$p_10_text;							
//on how to measure the area correctly to ensure all things are taken into consideration such as base molding, windows, electrical outlets, attic and floor crawl spaces, heat registers etc..
