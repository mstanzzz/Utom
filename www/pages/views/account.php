...
<main class="main clearfix">
	...
	Hi, <?php echo $cust_name; ?>
							...
							<ul class="account-nav">
								...
								<li>
									<a href="account.html" title="" class="account-nav__link active account-menu-hidden">
					...
					<div class="account-block__dashboard">
						<div class="account-block__dashboard-links">
							...
							<div class="account-block__dashboard-links--wrapper">
								...
								<div class="account-block__dashboard-links--holder">
									<a href="account-orders.html" title="" class="account-block__dashboard-links--link">View Order Receipt</a>
									<a href="account-orders.html" title="" class="account-block__dashboard-links--link">View all</a>
								</div>
							</div>
						</div>

						<div class="account-block__dashboard-links--wrapper">
							<a href="account-idea-folder.html" title="" class="account-block__dashboard-links--link-fixed"></a>
							<div class=" account-block__dashboard-links--content idea-folder">
								...
								<div class="account-block__dashboard-links--holder">
									<a href="account-idea-folder.html" title="" class="account-block__dashboard-links--link">View saved content</a>
								</div>
							</div>
						</div>

						<div class="account-block__dashboard-links--wrapper">
							<a href="account-settings.html" title="" class="account-block__dashboard-links--link-fixed"></a>
								<div class=" account-block__dashboard-links--content my-account">
									...
									<div class="account-block__dashboard-links--holder">
										<a href="account-settings.html" title="" class="account-block__dashboard-links--link">Change Password</a>
										<a href="account-settings.html" title="" class="account-block__dashboard-links--link">Change Address</a>
										<a href="account-settings.html" title="" class="account-block__dashboard-links--link">Update Preferences</a>
									</div>
								</div>
							</div>
						</div>
