...
sign in
			...
			<form id="reg_form" name="reg_form" action="<?php echo SITEROOT; ?>" method="post">
			<fieldset class="register" data-role="toggle-el-target" id="register">
				<div class="form-group form-group__default">
					<div class="form-control form-group__default__form-control home-consult-form__input">
						<input id="reg_name" name="reg_name" class="input" required type="text" placeholder="Name">
					</div>
					<div class="form-control form-group__default__form-control home-consult-form__input">
						<input id="reg_email" name="reg_email" class="input" required type="email" placeholder="Email Address">
					</div>
					<div class="form-control form-group__default__form-control home-consult-form__input">
						<input id="reg_password" name="reg_password" class="input" required type="password" placeholder="Password">
					</div>
					<div class="form-control form-group__default__form-control home-consult-form__input ">
						<input id="reg_con_password" name="reg_con_password"   class="input" required type="password" placeholder="Confirm password">
					</div>
				...
				<button  type="submit" name="register" value="r" class="btn btn-secondary btn-full btn-sign">Register</button>
			</fieldset>
			</form>							

			<form id="si_form" name="si_form" action="<?php echo SITEROOT; ?>" method="post">
			<fieldset class="sign-in cd-none" data-role="toggle-el-target" id="sign-in">
				<div class="form-group form-group__default">
					<div class="form-control form-group__default__form-control home-consult-form__input">
						<input id="si_email" name="si_email" class="input" required type="email" placeholder="Email Address">
					</div>
					<div class="form-control form-group__default__form-control home-consult-form__input">
						<input id="si_pswd" name="si_pswd" class="input" required type="password" placeholder="Password">
					</div>
					<p class="text-center">
