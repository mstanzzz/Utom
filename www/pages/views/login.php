...
<fieldset class="register" data-role="toggle-el-target" id="register">
	...
	<button name="register" type="submit" class="btn btn-secondary btn-full btn-sign">Register</button>
</fieldset>
...
<fieldset class="sign-in cd-none" data-role="toggle-el-target" id="sign-in">
	...
	<button name="sign_in" type="submit" class="btn btn-secondary btn-full btn-sign">Sign in</button>
</fieldset>
