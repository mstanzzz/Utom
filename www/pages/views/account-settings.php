								...
								<div class="account-block__navigation--user active js-not-login-txt">
									...
									<nav class="account-block__navigation--navigation">
										<ul class="account-nav">
											...
											<li>
												<a href="account-settings.html" title="" class="account-nav__link active account-menu-hidden">
											...
											<div class="row align-items-end mobile-change-password-row">
												<div class="col">
													<div class="form-group">
														...
														<input type="password" class="form-control readonly-pass" id="current-password" name="current-password" placeholder="Password" readonly value="********">
													</div>
												</div>
												<div class="col">
													<div class="form-group input-riqueired-group">
														<label for="new-password"></label>
														<input type="password" class="form-control input-riqueired" id="new-password" name="new-password" placeholder="New Password">
												...
												<div class="col">
													<div class="form-group input-riqueired-group">
														...
														<input type="password" class="form-control input-riqueired" id="confirm-new-password" placeholder="Confirm New Password">
														<span class="span-riqueried">*</span>
													</div>
												</div>
												<div class="col">
