...
data-role="toggle-el">+ Add new address</p>
<p class="cta cta__add  card-el__show-on-md"
type="button" data-toggle="modal"
data-target="#modal__add-address">+ Add new address</p>
</div>
</div>
	...
	<div class="form-row">
		...
		<div class="col">
			<div class="form-group">
				...
				echo "<option value='".$val['state_abr']."'>".$val['state']."</option>";
				}					
				?>
				</select>
			</div>
	...
	<div class="col">
		<div class="form-group">
			...
			<div class="home-consult-form__select ">
				...
				echo "<option value='".$val['country_abr']."'>".$val['country']."</option>";
				}					
				?>
				</select>
			</div>
...
<div class="form-row">
	<div class="col">
		<div class="form-group">
			<label class="label-above"
			for="customer-new__email_collapsed">
			Email Address:
			</label>
				...
				<div class="col-lg-5">
					...
					<div class="radio-image">
						...
						<li>
							...
							<img src="<?php echo SITEROOT; ?>images/footer-masterCard.png" class="img img-fluid" alt=""/>
							</label>
						</li>
						<li>
							<label class="pay__method-wrap">
							...
							<div class="row">
								<div class="col">
									<div class="iframe-wrap btn-load-page"
										...
										<img src="<?php echo SITEROOT; ?>images/enterbank.png" class="img-fluid"
...
<li>
	<div data-select="select-option__customer-address_2" class="select-option select-custom__option ">
		<div class="select-custom__option__wrap">
			<div class="select-custom__img-wrap">
				<img src="<?php echo SITEROOT; ?>images/master.svg" class="img-fluid" alt="">
			</div>
			<p class="select-custom__option__text">
			XXXX XXXX XXXX 1234
			</p>
	...
	<div class="col-lg-4 col-md__max-366">
		...
		<div class="col-lg-4 col-md__max-366">
			<div class="pay-card__wrap pay-card__wrap__cv">
				<div class="pay-card">
					<div class="pay-card__card-number__background"> </div>
						<div class="row mt-4">
							<div class="col-9"></div>
								<div class="col-3">
...
<div class="card card-checkout you-design__mark">
				...
				<div class="card-body d-flex align-items-center">
					<div class="card-checkout__product__image mr-3">
						...
						<div class="img-wrap">
							<img src="<?php echo SITEROOT; ?>images/hardware-resources-knob-oil-rubbed-bronze.png" class="img-fluid" alt="">
						</div>
					</div>
					<div class="card-checkout__product">
			...
			<div class="card card-checkout card-fixed__inner card-shadow no-border">
				<div class="card-body card-order">
					...
					<div class="form-group form-promo">
						<label class="label-above form-promo__label" for="input__promo-code">
						Promo code:
						</label>
						<div class="form-row">
							<div class="col-8">
...
You have completed all required fields. Please click "Continue"
</div>
...
<li class="text">
2. Email the photo to: closetstogo@email.address; Subject: 156rt68yu
</li>
<li class="text">
3. Click "Continue"
</li>
...
<!-- Modal e-sign  - "thanks for submitting" modal -->
