...
<section class="home-mobile-buttons-block covid-block showroom-page product-detail">
<div 
	class="accordion accordion-organizer-landing-page showroom-details product-detail"
	...
	<div class="card">
		<div class="d-flex align-items-center pl-2">
			<a href="#" class="d-flex align-items-center">
				...
				<defs><style>.arrow-new {fill: #ffffff;}</style></defs>
			...
			<div class="card-body">
				<div class="bootstrap-select__ctg__wrap organizer-filters-block__wrapper js-filters-box">
					...
					<div class="bootstrap-select__ctg">
						<select class="select-stg multiselectbox selectpicker"
						multiple
						title="Color">
			...
			<div class="row">
				<div class="col-12">
					<div class="simple-block__heading">
						<h2 class="simple-block__heading--heading text-center">Murphy Bed DesignIdeas</h2>
						<div class="product-purchase__buttons">
							...
							<defs><style>.share-no-background {fill: #384765;}</style></defs>
						...
						<div class="account-mobile-more-info-wrapper js-show-mobile-action-buttons">
							<div class="account-mobile-more-info-wrapper__mobile-more-info">
								...
								<defs><style>.files {fill: #DB440D;}</style></defs>
...
<div class="col-12 desktop-show ">
	<div class="simple-block__filters simple-block__filters__centered js-product-filters">
		...
		<div class="dropdown dropdown__filter" style="min-width: 110px">
			...
			<div class="dropdown-list">
				<div class="checkbox">
					...
					<span class="checkbox-label__text">S</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">M</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">L</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">XL</span>
					</label>
				</div>
			</div>
		</div>
		...
		<div class="dropdown dropdown__filter" style="min-width: 110px">
			...
			<div class="dropdown-list">
				<div class="checkbox">
					...
					<span class="checkbox-label__text">cotton</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">bamboo</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">glass</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">metal</span>
					</label>
				</div>
			</div>
		</div>
		<div class="dropdown dropdown__filter" style="min-width: 135px">
			...
			data-default-text="Specification">
			Specification
			</label>
			<div class="dropdown-list">
				<div class="checkbox">
					...
					<span class="checkbox-label__text">80*60*40cm</span>
					</label>
				</div>
				<div class="checkbox">
					<input type="checkbox"
					...
					<span class="checkbox-label__text">60*40*30cm</span>
					</label>
				</div>
					<div class="checkbox">
						<input type="checkbox"
						...
						<span class="checkbox-label__text">50*40*30cm</span>
						</label>
					</div>
					<div class="checkbox">
						<input type="checkbox"
						...
						<span class="checkbox-label__text">40*40*25cm</span>
						</label>
					</div>
					<div class="checkbox">
						<input type="checkbox"
						...
						<span class="checkbox-label__text">33*15*85cm</span>
						</label>
					</div>
				</div>
			</div>
...
<div><img src="<?php echo SITEROOT; ?>images/yt-placeholder.png" class="img-fluid prod-detail__nav-img"></div>
<div><img src="<?php echo SITEROOT; ?>images/showroom-1.png" class="img-fluid prod-detail__nav-img"></div>
<div><img src="<?php echo SITEROOT; ?>images/showroom-1.png" class="img-fluid prod-detail__nav-img"></div>
<div><img src="<?php echo SITEROOT; ?>images/showroom-1.png" class="img-fluid prod-detail__nav-img"></div>
<div><img src="<?php echo SITEROOT; ?>images/showroom-1.png" class="img-fluid prod-detail__nav-img"></div>
<div><img src="<?php echo SITEROOT; ?>images/showroom-1.png" class="img-fluid prod-detail__nav-img"></div>
...
<a href="#" class="btn btn-primary pt-2 pb-2  ">back to filters</a>
</div>
</div>
</div>
</div>
...
<span>5% off</span>
<button type="button"
class="product-purchase__quantity-tooltip" data-toggle="tooltip" data-placement="top"
...
aria-controls="pills-specifications" aria-selected="false">
Specifications
</a>
</li>
<li class="nav-item">
...
aria-controls="pills-Installations" aria-selected="false">
Installations
</a>
</li>
</ul>
...
materials at affordable prices. Guaranteed easy install and ships free.
</p>
...
<div class="tab-content__specifications--description-content">
<img src="<?php echo SITEROOT; ?>images/specification-description-2.png" class="img-fluid">
<div class="tab-content__specifications--description-text">
...
<div class="tab-content__specifications--description-content">
<img src="<?php echo SITEROOT; ?>images/specification-description-3.png" class="img-fluid">
<div class="tab-content__specifications--description-text">
...
<div class="block-stars__wrapper">
<img src="<?php echo SITEROOT; ?>images/Rectangle12.png" class="block-stars__wrapper--image">
<div class="block-stars__wrapper--text">
<div class="stars-container">
<img src="<?php echo SITEROOT; ?>images/star.svg" alt="">
<img src="<?php echo SITEROOT; ?>images/star.svg" alt="">
...
<div class="row">
<div class="col-12 col-lg-6">
<p class="product-dyi-installer__heading">DIY installer</p>
</div>
<div class="col-12 col-lg-6">
...
Tools required to complete the installation</p>
</div>
</div>
<div class="row">
<div class="col-12">
...
<div class="row">
<div class="col-12">
<h2 class="second-block__first--heading">Related products</h2>
<div class="row mt-4">
...
<figcaption>
<p>Closet Organizers: Custom-designed by you, quality-b...</p>
</figcaption>
</figure>
</a>
</div>
...
<div class="row">
<div class="col-12">
<h2 class="second-block__first--heading">Previously viewed</h2>
<div class="row mt-4">
<div class="col-12 five-elements-block__content">
<div class="five-elements-block__wrapper services-caro">
<div class="five-elements-block__wrapper--item mt-0">
			...
			<div class="row showroom-detail-product-row">
				<div class="col-12 col-xl-7 showroom-detail-product-col-lg">
					<div class="you-design-block__image">
						<img src="<?php echo SITEROOT; ?>images/you-design-product.png" class="img-fluid">
					</div>
				</div>
...
<a href="#" title="" class="mobile-footer-buttons__second">
<img src="<?php echo SITEROOT; ?>images/icon-save.svg" class="img-fluid"></a>
