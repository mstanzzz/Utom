...
<html lang="en">
	...
	<meta name="description" content="organizer-landing-page"><link href="app.css" rel="stylesheet"></head>
	...
	<body class="clearfix">
					...
					<div class="card-header" id="headingOne">
						<h2 class="mb-0">
							<button class="accordion-organizer-button js-filter-fix-body" type="button"
								...
								Search
								<svg xmlns="http://www.w3.org/2000/svg" width="22.113" height="22.905"
									 viewBox="0 0 22.113 22.905">
									<path id="search_1_" data-name="search(1)"
										  d="M22.761,20.862l-5.451-5.67a9.244,9.244,0,1,0-7.078,3.3,9.149,9.149,0,0,0,5.3-1.673l5.493,5.713a1.206,1.206,0,1,0,1.739-1.672ZM10.232,2.412A6.835,6.835,0,1,1,3.4,9.248,6.843,6.843,0,0,1,10.232,2.412Z"
										  transform="translate(-0.984)" fill="#384765"/>
								</svg>
							</button>
						</h2>
					</div>
									...
									<div class="my-custom-select">
										...
										<div class="my-custom-options">
											...
											<span class="my-custom-option"
												  data-value="Chocolate pear">Chocolate pear</span>
											<span class="my-custom-option"
												  data-value="Antique white">Antique white</span>
								...
								<div class="w-100 text-center">
									<div class="form-group accordion-organizer-form-group">
										...
										<input type="text" name="enter-tag"
											   class="form-control accordion-organizer-form-input"
											   placeholder="Enter tag">
									</div>
									<button
											class="btn btn-secondary accordion-organizer-submit js-filter-fix-body"
											data-toggle="collapse" data-target="#collapseOne">Search
									</button>
									<!--</form>-->
								</div>
							</div>
		...
		<section class="first-fixed-block covid-block organizer-landing-page clearfix">
			<figure class="col-12 first-fixed-block__img-group"
					style="background-image: url('images/organizer-landing-pahe-header.png');">
								...
								<div class="organizer-filters-block__wrapper">
									...
									<div class="my-custom-select-wrapper">
										<div class="my-custom-select">
											...
											<div class="my-custom-options">
												...
												<span class="my-custom-option" data-value="All">All</span>
												<span class="my-custom-option"
													  data-value="Traditional">Traditional</span>
												<span class="my-custom-option"
													  data-value="Contemporary">Contemporary</span>
												<span class="my-custom-option" data-value="Modern">Modern</span>
												<span class="my-custom-option" data-value="Minimalist">Minimalist</span>
												<span class="my-custom-option" data-value="Industrial">Industrial</span>
												<span class="my-custom-option"
													  data-value="Shabby Chic">Shabby Chic</span>
												<span class="my-custom-option" data-value="Rustic">Rustic</span>
												<span class="my-custom-option" data-value="Luxurious">Luxurious</span>
											</div>
										</div>
									...
									<div class="my-custom-select-wrapper">
										<div class="my-custom-select">
											...
											<div class="my-custom-options">
												<span class="my-custom-option selected"
													  data-value="Colors">Colors</span>
												<span class="my-custom-option" data-value="All">All</span>
												<span class="my-custom-option" data-value="White">White</span>
												<span class="my-custom-option" data-value="Night fall">Night fall</span>
												...
												<span class="my-custom-option" data-value="Almond">Almond</span>
												<span class="my-custom-option"
													  data-value="Custom grey">Custom grey</span>
												<span class="my-custom-option" data-value="Maple">Maple</span>
												<span class="my-custom-option" data-value="Mahogany">Mahogany</span>
											</div>
										</div>
									...
									<form class="form-inline align-items-start">
										<div class="form-group">
											<label for="enter-tag" class="sr-only">Enter tag</label>
											<input type="text" name="enter-tag" class="form-control"
												   placeholder="Enter tag">
										</div>
						...
						<div class="row showroom-block__wrapper">
							<div class="col-12 col-lg-6 hidden-box open">
								<figure class="showroom-block__item">
									<img src="images/showroom-1.png" alt="" class="showroom-block__item--img">

									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											<h2>Showroom product preview</h2>
											<a href="#" title="" class="link-button">
												Explore now
												<svg xmlns="http://www.w3.org/2000/svg" width="20.8" height="14.623"
													 viewBox="0 0 20.8 14.623">
											...
											<button class="save-for-idea" data-img-path="images/showroom-1.png"
													tabindex="0">
							...
							<div class="col-6 col-lg-3 hidden-box open">
								<figure class="showroom-block__item">
									<img src="images/showroom-2.png" alt="" class="showroom-block__item--img">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-2.png"
													tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button>
										</div>
							...
							<div class="col-6 col-lg-3 hidden-box open">
								<figure class="showroom-block__item">
									<img src="images/showroom-3.png" alt="" class="showroom-block__item--img">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-3.png"
													tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
							...
							<div class="col-12 col-lg-3 hidden-box open">
								<figure class="showroom-block__item">
									<img src="images/showroom-4.png" alt="" class="showroom-block__item--img">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-4.png"
													tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
							...
							<div class="col-6 col-lg-3 hidden-box open">
								<figure class="showroom-block__item">
									<img src="images/showroom-5.png" alt="" class="showroom-block__item--img">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<button class="save-for-idea" data-img-path="images/showroom-5.png"
													tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
							...
							<div class="col-6 col-lg-6 hidden-box open">
								<figure class="showroom-block__item">
									<img src="images/showroom-6.png" alt="" class="showroom-block__item--img">
									...
									<figcaption class="showroom-block__item--wrapper">
										<div class="showroom-block__item--content">
											...
											<a href="#" title="" class="link-button d-none">
												Explore now
												<svg xmlns="http://www.w3.org/2000/svg" width="20.8" height="14.623"
													 viewBox="0 0 20.8 14.623">
													<path id="left-arrow_3_" data-name="left-arrow(3)"
											...
											<button class="save-for-idea" data-img-path="images/showroom-6.png"
													tabindex="0">
												<!-- <img src="images/icon-save-white.svg" alt="" class="img-fluid"> -->
											</button
										</div>
