...
<html lang="en">
	...
	<body>
		...
		<section class="first-fixed-block covid-block clearfix">
			<figure class="first-fixed-block__img-group" style="background-image: url('../../images/solution-detail-view-header.png');">
				<figcaption class="first-fixed-block__img-group--text-block">
					<div class="wrapper">
						<h1 class="first-fixed-block__img-group--heading">Closets To Go His and Her Walk</h1>
						<!-- <h3 class="first-fixed-block__img-group--subheading">Lorem ipsum dolor sit amet, consectetur.</h3> -->
						<p class="first-fixed-block__img-group--text">in Closet Organizers with	double hanging closet rods, double hutch with drawers, shoe storage, 
							center island, shelving</p>
					</div>
				</figcaption>
			</figure>
		</section>
		...
		<main class="main clearfix">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="#">Custom closet organizers for
											wardrobes</a></li>
										<li class="breadcrumb-item active" aria-current="page">His and her walk in
											closet organizers
										</li>
									</ul>
								</div>
									...
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading">Closets To Go His and Her Walk in Closet Organizers</h2>
											</div>
										</div>
									</div>
									<div class="row">
			...
			<section class="solution-block-carousel">
				<div class="wrapper">
					<div class="solution-block-carousel__wrapper">
						<div class="solution-block-carousel__wrapper--image-block">
							<a href="images/solution-carousel-img-1.png" data-lightbox="roadtrip" data-title="Lorem ipsum">
								<img src="../../images/solution-carousel-img-1.png" alt="" class="img-fluid">
							</a>
						...
						<div class="row">
							<div class="col-12 col-xl-7">
								<div class="two-elements-block__wrapper">
									<h2 class="two-elements-block__wrapper--heading">Products</h2>
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-12 five-elements-block__content">
								<div class="five-elements-block__wrapper">
