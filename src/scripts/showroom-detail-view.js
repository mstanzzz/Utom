...
jQuery(document).ready(function ($) {
	...
	// popup slider:
	//swich carosels
	if ($('.js-switch-carosel-mobile-wrap-sec').length >= 1) {
		if ($(window).width() >= 992) {
			if ($('.js-switch-carosel-mobile.secm').has('showroom-detail-product__carousel.sec')) {
				carouselById('.showroom-detail-product__carousel.sec', '.showroom-detail-product__carousel-nav.sec', false);
			} else {
				$('.js-switch-carosel-mobile.secm').removeClass('video-caro').addClass('showroom-detail-product__carousel.sec');
				carouselById('.showroom-detail-product__carousel.sec', '.showroom-detail-product__carousel-nav.sec', false);
			}
		} else {
			if ($('.js-switch-carosel-mobile.secm').has('showroom-detail-product__carousel.sec')) {
				$('.js-switch-carosel-mobile.secm').removeClass('showroom-detail-product__carousel.sec').addClass('video-caro');
			}
		}
	}
	...
	$(window).on({
		resize: function () {
			...
			if ($(window).width() >= 992) {
				if ($('.js-switch-carosel-mobile.secm').has('showroom-detail-product__carousel2')) {
					carouselById('.showroom-detail-product__carousel2', '.showroom-detail-product__carousel-nav.sec', false);
				} else {
					$('.js-switch-carosel-mobile.secm').removeClass('video-caro').addClass('showroom-detail-product__carousel.sec');
					carouselById('.showroom-detail-product__carousel2', '.showroom-detail-product__carousel-nav.sec', false);
				}
